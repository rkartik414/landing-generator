      ...
      <div className="hvf-content">
        <div className="hvf-inner">
          <h1 className="hvf-h1 anim d0">
            <span className="hvf-accent">create</span> High-Quality AI Images & Videos with ByteDance Generative Models
          </h1>
          ...
          <div className="hvf-pill anim d2">
            <input type="text" className="hvf-input" placeholder="Enter your email for updates..." />
            <button className="hvf-btn">Generate with AI</button>
          </div>
          <div className="hvf-proof">
            <div className="hvf-avatars">
              <div className="hvf-av" style={{ backgroundColor: '#4caf50' }}>A</div>
              <div className="hvf-av" style={{ backgroundColor: '#2196f3' }}>B</div>
              <div className="hvf-av" style={{ backgroundColor: '#ffeb3b' }}>C</div>
              <div className="hvf-av" style={{ backgroundColor: '#ff5722' }}>D</div>
            </div>
            <div className="hvf-stars">
              <svg width="20" height="20" fill={var(--accent)}><polygon points="10,1.5 12.5,7 18.5,7 13.5,11 15,17 10,13.5 5,17 6.5,11 1.5,7 7.5,7" /></svg>
              <svg width="20" height="20" fill={var(--accent)}><polygon points="10,1.5 12.5,7 18.5,7 13.5,11 15,17 10,13.5 5,17 6.5,11 1.5,7 7.5,7" /></svg>
              <svg width="20" height="20" fill={var(--accent)}><polygon points="10,1.5 12.5,7 18.5,7 13.5,11 15,17 10,13.5 5,17 6.5,11 1.5,7 7.5,7" /></svg>
              <svg width="20" height="20" fill={var(--accent)}><polygon points="10,1.5 12.5,7 18.5,7 13.5,11 15,17 10,13.5 5,17 6.5,11 1.5,7 7.5,7" /></svg>
              <svg width="20" height="20" fill={var(--accent)}><polygon points="10,1.5 12.5,7 18.5,7 13.5,11 15,17 10,13.5 5,17 6.5,11 1.5,7 7.5,7" /></svg>
...
<section className="tms">
  <div className="tms-grid">
    <div className="tms-cell reveal visible">
      <div className="tms-val" data-count="10000">10,000+</div>
      <div className="tms-label">Happy Customers</div>
      <div className="tms-note">Transform ideas into visuals instantly.</div>
    </div>
    <div className="tms-cell reveal visible">
      <div className="tms-val" data-count="98">98%</div>
      <div className="tms-label">Satisfaction Rate</div>
      <div className="tms-note">Based on verified reviews</div>
    </div>
    <div className="tms-cell reveal visible">
      <div className="tms-val" data-count="4.8">4.8</div>
      <div className="tms-label">Average Rating</div>
      <div className="tms-note">1,020+ verified reviews</div>
    </div>
  </div>
</section>
      ...
      <div className="falt-block reveal">
        ...
        <div className="falt-copy">
          ...
          <div className="falt-chips">
            <div className="falt-chip">Advanced Text–Image Alignment</div>
            <div className="falt-chip">High-Resolution Output</div>
            <div className="falt-chip">Superior Typographic Rendering</div>
            <div className="falt-chip">Multi-Image Composition with Identity Preservation</div>
          </div>
        </div>
        <div className="falt-visual">
          <img src="/output/generated-assets/ds_1778068948410_3d8b5a72/05-6d75b26b02.webp" alt="AI Image Generation" />
        </div>
      </div>
      <div className="falt-block reveal visible flip">
        ...
        <div className="falt-copy">
          ...
          <div className="falt-chips">
            <div className="falt-chip">Key Capabilities of Seedance 1.5 Pro</div>
            <div className="falt-chip">Text-to-Video Generation</div>
            <div className="falt-chip">Audio-Visual Synchronization</div>
            <div className="falt-chip">Multilingual Lip-Sync</div>
          </div>
        </div>
        <div className="falt-visual">
          <img src="/output/generated-assets/ds_1778068948410_3d8b5a72/02-61e034e16c.png" alt="AI Video Generation" />
        </div>
      </div>
    </section>
  ); 
...
<section className="fig">
  ...
  <div className="fig-grid">
    {[
      ...
      <div key={index} className="fig-card anim d" style={{ animationDelay: `${index * 0.15}s` }}>
    ...
    {[
      ...
      <div className={`gvw-card anim-scale d${index}`} key={index}>
        <div className="gvw-video">
          <video autoPlay muted loop playsInline src={video.url}></video>
        </div>
...
{(() => { 
  const points = [
    {"title":"Free Expert Consultation","description":"Get matched with the right software by our B2B experts."},
    {"title":"1,020+ Verified Reviews","description":"Real feedback from genuine customers across India."},
    {"title":"Best Price Guarantee","description":"Competitive pricing with EMI options available."},
    {"title":"Dedicated Post-Sale Support","description":"Onboarding, training, and ongoing assistance."}
  ]; 
      ...
      <div className="wtj-inner">
        ...
        <div className="wtj-grid">
          {points.map((point, index) => (
            <div className="wtj-card anim d" key={index}>
              <div className="wtj-icon">
                <svg width="20" height="20" fill="var(--accent)" xmlns="http://www.w3.org/2000/svg">
...
<section className="pdc">
  <div className="pdc-head anim d0">
    ...
    <h2>Seedream 4.5 and Seedance 1.5 Pro Plans</h2>
  </div>
  <div className="pdc-grid">
    <div className="pdc-card">
      <div className="pdc-plan">Seedream 4.5 (AI Image Generation)</div>
      <div className="pdc-desc"></div>
      <div className="pdc-list">
        <li><svg className="pdc-check" viewBox="0 0 24 24"><path d="M9 19l-7-7 2-2 5 5 12-12 2 2z" /></svg> High-resolution image generation (up to 4K quality)</li>
        <li><svg className="pdc-check" viewBox="0 0 24 24"><path d="M9 19l-7-7 2-2 5 5 12-12 2 2z" /></svg> Text-to-image & multimodal image editing</li>
        <li><svg className="pdc-check" viewBox="0 0 24 24"><path d="M9 19l-7-7 2-2 5 5 12-12 2 2z" /></svg> Multi-image composition for complex visuals</li>
        <li><svg className="pdc-check" viewBox="0 0 24 24"><path d="M9 19l-7-7 2-2 5 5 12-12 2 2z" /></svg> Enhanced typographic rendering for posters, ads & text-heavy designs</li>
      </div>
      <button className="pdc-btn">Get Quote</button>
    </div>
    <div className="pdc-card featured">
      <div className="pdc-badge">Featured</div>
      <div className="pdc-plan">Seedance 1.5 Pro (AI Video Generation)</div>
      <div className="pdc-price">
        <span className="pdc-amount">Starting at $1,000/month/</span>
      </div>
      <div className="pdc-list">
        <li><svg className="pdc-check" viewBox="0 0 24 24"><path d="M9 19l-7-7 2-2 5 5 12-12 2 2z" /></svg> Text-to-video generation with cinematic output</li>
        <li><svg className="pdc-check" viewBox="0 0 24 24"><path d="M9 19l-7-7 2-2 5 5 12-12 2 2z" /></svg> Native audio + video generation (synchronized)</li>
        <li><svg className="pdc-check" viewBox="0 0 24 24"><path d="M9 19l-7-7 2-2 5 5 12-12 2 2z" /></svg> Multilingual lip-sync capabilities</li>
        <li><svg className="pdc-check" viewBox="0 0 24 24"><path d="M9 19l-7-7 2-2 5 5 12-12 2 2z" /></svg> Fast inference for quicker video production</li>
      </div>
      <button className="pdc-btn">Get Quote</button>
    </div>
  </div>
...
<section className="tcar">
  <div className="tcar-head anim d0">
    <div className="eyebrow">Loved by teams using Seedream 4.5 and Seedance 1.5 Pro</div>
    <h2>Real feedback from real users.</h2>
  </div>
  <div className="tcar-layout">
    <div className="tcar-rail">
      {[
        {"quote":"Seedream allows us to generate high-resolution creative visuals from simple prompts. It has dramatically reduced our design turnaround time.","author":"Vaishali Saxena","designation":"Creative Director","company":""},
        {"quote":"Seedance’s ability to generate synchronized audio and video is incredibly powerful for storytelling and branded content.","author":"Vihaan Pandey","designation":"Video Producer","company":""},
        {"quote":"The multimodal editing capabilities in Seedream make it easy to refine images with precision.","author":"Anurag Malhotra","designation":"Art Director","company":""}
        ...
        <div className="tcar-mini" key={index}>
          ...
          <div className="tcar-author">
            <div className="tcar-avatar" style={{background: `hsl(${(index * 60) % 360}, 70%, 50%)`}}>
    ...
    <div className="tcar-stage">
      <div className="tcar-track" style={{transform: `translateX(-${slide * 100}%)`}}>
        {[
          ...
          {"quote":"Seedance’s ability to generate synchronized audio and video is incredibly powerful for storytelling and branded content.","author":"Vihaan Pandey","designation":"Video Producer","company":""},
          {"quote":"The multimodal editing capabilities in Seedream make it easy to refine images with precision.","author":"Anurag Malhotra","designation":"Art Director","company":""},
          {"quote":"Techjockey made it easy to evaluate Seedream (AI Image Generation) and Seedance (AI Video Generation). The free demo helped us clearly understand the capabilities before making a decision.","author":"Ashutosh Singh","designation":"Marketing Manager","company":""},
          {"quote":"From understanding our needs to arranging a free demo of Seedream and Seedance, Techjockey simplified the entire buying journey. Quick, smooth, and hassle-free.","author":"Shrimmi Saxena","designation":"Creative Lead","company":""}
        ].map((testimonial, index) => (
  ...
  <div className="tcar-dots">
    {Array.from({length: 5}).map((_, index) => (
      <button className={`tcar-dot ${index === slide ? 'active' : ''}`} key={index}></button>
    ))}
  </div>
</section>
); })()}
  ...
  return (
    <section className="ctavb anim">
      ...
      <div className="ctavb-inner">
        <h2 className="anim d0">Experience Seedream 4.5 and Seedance 1.5 Pro today</h2>
        <p className="anim d1">Start generating in minutes. No setup required.</p>
        <a href="#lead-form" className="ctavb-btn anim d2">Generate with AI</a>
      </div>
    </section>
  );
})()}
