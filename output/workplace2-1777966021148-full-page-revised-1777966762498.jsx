...
const LandingPage = () => {
  ...
  const css = `
    ...
    *{box-sizing:border-box} html,body{margin:0;padding:0;background:${bodyBg};scroll-behavior:smooth}
    ...
    .hero-grid{display:grid;grid-template-columns:1.02fr .98fr;gap:32px;align-items:center;min-height:calc(100vh - 72px);padding:42px 0}
    ...
    .dashboard-shell{position:relative;width:100%;max-width:700px}
    .hero-media-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px;align-items:stretch}
    ...
    .desc-bar{border-left:3px solid ${accent};padding-left:16px;margin:14px 0 16px}
    ...
    .feature-browser img{width:100%;height:100%;min-height:320px;max-height:320px;display:block;object-fit:cover;object-position:center}
    ...
    .dot-ind{width:8px;height:8px;border-radius:999px;background:#d1d5db;transition:.3s ease}
    ...
    .reveal,.reveal-left,.reveal-right,.reveal-scale,.stagger-parent>*{opacity:0;transform:translateY(24px);transition:all .7s cubic-bezier(.16,1,.3,1)}
    ...
    .stagger-parent>*:nth-child(2){transition-delay:.12s}
    .stagger-parent>*:nth-child(3){transition-delay:.19s}
    .stagger-parent>*:nth-child(4){transition-delay:.26s}
    .stagger-parent>*:nth-child(5){transition-delay:.33s}
    .stagger-parent>*:nth-child(6){transition-delay:.40s}
    @keyframes marqueeScroll{0%{transform:translateX(0)}100%{transform:translateX(-50%)}}
    @keyframes pageReveal{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}}
    @media (max-width: 1024px){
      .hero-grid,.trust-grid,.feature-spotlight{grid-template-columns:1fr}
      .hero-visual{order:-1;min-height:auto}
      .feature-media,.hero-media-grid{grid-template-columns:1fr 1fr}
      .logos-grid{grid-template-columns:repeat(3,1fr)}
      .float-1,.float-2,.float-3{display:none}
    }
    @media (max-width: 767px){
      .section{padding:52px 0}
      .nav-inner,.footer-grid{grid-template-columns:1fr;justify-items:start}
      .hero-grid{padding:28px 0 36px}
      .hero-sub{font-size:16px}
      .feature-grid,.checklist,.feature-media,.hero-media-grid{grid-template-columns:1fr}
      .logos-grid{grid-template-columns:repeat(2,1fr)}
      .browser-frame img,.feature-browser img{height:auto;min-height:240px;max-height:none}
    ...
    <div ref={pageRef} className="page-wrapper">
      ...
      <nav className="nav">
        <div className="container nav-inner">
          ...
          <img
            className="tj-logo"
            src="/output/generated-assets/ds_1777965779159_1c1bdf36/1-3da9f6ef63.png"
            alt="Techjockey"
          />
      ...
      <header className="hero section">
        <div className="container hero-grid">
          <div className="reveal-left">
            <div className="tag" style={{ background: 'rgba(255,255,255,.12)', color: '#fff', borderColor: 'rgba(255,255,255,.22)' }}>
              UNIFIED COLLABORATION SUITE
            </div>
            <h1 className="hero-headline">
              Power your teams with <span style={{ color: '#fff7d6' }}>Zoho Workplace</span>
            </h1>
            <p className="hero-sub">
              Bring email, chat, documents, meetings, file storage, and collaboration into one secure workspace built for modern businesses.
            </p>
            <div className="hero-chips">
              <span className="chip">{iconSvg} Business Email</span>
              <span className="chip">{iconSvg} Team Collaboration</span>
              <span className="chip">{iconSvg} Secure Cloud Apps</span>
            </div>
            ...
            <div className="dashboard-shell">
              <div className="hero-media-grid">
                <div className="browser-frame browser-light">
                  ...
                  <img
                    src="/output/generated-assets/ds_1777965779159_1c1bdf36/18-473c14de05.jpg"
                ...
                <div className="browser-frame browser-light">
                  ...
                  <img
                    src="/output/generated-assets/ds_1777965779159_1c1bdf36/30-89ce3cb959.jpeg"
                    alt="Zoho Workplace collaboration view"
                  />
                </div>
              </div>
      ...
      <section className="section-sm">
        <div className="marquee-wrapper">
          <div className="marquee-track">
            {['EMAIL', 'CHAT', 'MEETINGS', 'DOCUMENTS', 'FILE STORAGE', 'COLLABORATION', 'SECURITY', 'PRODUCTIVITY', 'EMAIL', 'CHAT', 'MEETINGS', 'DOCUMENTS', 'FILE STORAGE', 'COLLABORATION', 'SECURITY', 'PRODUCTIVITY'].map((item, idx) => (
      ...
      <section className="section">
        <div className="container trust-grid">
          <div className="trust-stat reveal-left">
            <p style={{ fontWeight: 700, color: '#111', marginBottom: 8 }}>Trusted solution ecosystem</p>
            <div className="num" data-count="5">0</div>
            <p style={{ marginBottom: 0 }}>Recognized platforms and tools businesses work with every day.</p>
          </div>
          <div className="logos-grid stagger-parent reveal-right">
              ...
              <div className="feature-copy reveal-left">
                <div className="desc-bar">
                  <p style={{ marginBottom: 0 }}>
                    {section.description || 'Explore how Zoho Workplace helps teams work smarter with connected communication and collaboration tools.'}
                  </p>
                </div>
                ...
                <div style={{ marginTop: 20 }}>
                  <a href={ctas[Math.min(index, ctas.length - 1)].href} className="animated-cta btn-magnetic">
                    {ctas[Math.min(index, ctas.length - 1)].text}
                  </a>
                </div>
              </div>
              ...
              <div className="feature-media reveal-right">
                ...
                <div className="feature-browser">
                  <div className={`browser-frame ${section.dark ? 'browser-dark' : 'browser-light'}`}>
                    ...
                    <img src={section.secondaryImage} alt={`${section.headline} secondary`} />
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="section">
        <div className="container">
          <div className="section-head reveal" style={{ textAlign: 'center', marginInline: 'auto' }}>
            ...
            <p>Choose a productivity suite designed for secure communication, collaboration, and scalable business growth.</p>
          </div>
            ...
            <div className="pricing-card">
              <div className="price-head">
                <div>
                  ...
                  <p style={{ marginBottom: 0 }}>Business productivity suite for growing teams</p>
                </div>
                <span className="badge-green">Best Value</span>
              </div>

              <div className="price-line">
                <span className="old-price">Custom pricing</span>
                <span className="new-price">On Request</span>
              </div>

              <div className="checklist">
                <div className="check">{iconSvg}<span>Enterprise-grade custom email</span></div>
                <div className="check">{iconSvg}<span>Team chat and video meetings</span></div>
                <div className="check">{iconSvg}<span>Collaborative office suite</span></div>
                <div className="check">{iconSvg}<span>Cloud file storage and sharing</span></div>
                <div className="check">{iconSvg}<span>Migration assistance</span></div>
                <div className="check">{iconSvg}<span>Advanced security controls</span></div>
              </div>
          ...
          <div className="testi-shell reveal-scale">
            ...
            <div className="dots">
              {testimonials.map((_, i) => (
                <span
                  key={i}
                  className={`dot-ind ${i === activeSlide ? 'active' : ''}`}
      ...
      <footer className="footer">
        <div className="container footer-grid">
          <div>
            <div className="brand-logo" style={{ color: '#fff', marginBottom: 8 }}>Zoho Workplace</div>
            <small>© 2026 Techjockey Infotech Pvt. Ltd. All rights reserved.</small>
          </div>
          <a href={ctas[0].href} className="animated-cta btn-magnetic">
            {ctas[0].text}
          </a>
