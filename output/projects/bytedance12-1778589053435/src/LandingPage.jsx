...
<section className="tms" style={{background:'#ffffff',padding:'40px 0'}}>
  <div className="tms-grid" style={{display:'flex',justifyContent:'space-around',alignItems:'center',textAlign:'center',maxWidth:'1200px',margin:'0 auto'}}>
    <div className="tms-cell stagger-parent" style={{flex:'1',margin:'0 20px'}}>
      <div className="tms-val" data-count="1000" style={{fontSize:'48px',fontWeight:'700',color:'#ff6b00'}}>1,000+</div>
      <div className="tms-label" style={{fontSize:'18px',fontWeight:'600',color:'#333'}}>Satisfied Clients</div>
      <div className="tms-note" style={{fontSize:'14px',color:'#666'}}>Experience the transformative power of Seedream and Seedance.</div>
    </div>
    <div className="tms-cell stagger-parent" style={{flex:'1',margin:'0 20px'}}>
      <div className="tms-val" data-count="95" style={{fontSize:'48px',fontWeight:'700',color:'#ff6b00'}}>95%</div>
      <div className="tms-label" style={{fontSize:'18px',fontWeight:'600',color:'#333'}}>Customer Satisfaction</div>
      <div className="tms-note" style={{fontSize:'14px',color:'#666'}}>Our commitment to high-quality AI-driven solutions.</div>
    </div>
    <div className="tms-cell stagger-parent" style={{flex:'1',margin:'0 20px'}}>
      <div className="tms-val" data-count="24" style={{fontSize:'48px',fontWeight:'700',color:'#ff6b00'}}>24/7</div>
      <div className="tms-label" style={{fontSize:'18px',fontWeight:'600',color:'#333'}}>Support Availability</div>
      <div className="tms-note" style={{fontSize:'14px',color:'#666'}}>Continuous support to cater to all your needs.</div>
    </div>
  </div>
  <img src="/output/generated-assets/seedream-4-5-and-seedance-1-5-pro-by-bytedance/15-41ea7f7485.png" alt="Seedream 4.5 and Seedance 1.5 Pro" style={{width:'100%',height:'100%',objectFit:'cover',display:'block',position:'absolute',inset:0}}/>
</section>

<section className="falt" style={{background: '#ffffff'}}>
  <div className="falt-head anim d0" style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '40px 20px'}}>
    <div style={{flex: '1'}}>
      <span className="eyebrow" style={{fontSize: '14px', color: '#ff6b00', marginBottom: '8px', display: 'inline-block'}}>Section Label</span>
      <h2 style={{fontFamily: 'Plus Jakarta Sans', fontSize: 'clamp(32px, 5vw, 60px)', margin: '0 0 20px', color: '#000'}}>Create High-Quality AI Images & Videos with ByteDance Generative Models</h2>
    </div>
  ...
  <div className="falt-block reveal" style={{display: 'flex', flexDirection: 'column', margin: '20px 0', padding: '20px', background: '#f8fafc', borderRadius: '12px'}}>
    <div className="falt-num" style={{fontSize: '28px', fontFamily: 'Plus Jakarta Sans', color: '#ff6b00', marginBottom: '10px'}}>01</div>
    <h3 style={{fontFamily: 'Plus Jakarta Sans', fontSize: '22px', color: '#000', margin: '0 0 10px'}}>AI Image Generation with Seedream 4.5</h3>
    <p style={{fontFamily: 'googleSansFlex', color: '#555', margin: '0 0 20px'}}>
    ...
    <div className="falt-chips" style={{display: 'flex', flexWrap: 'wrap', gap: '8px', marginBottom: '20px'}}>
      {["Advanced Text–Image Alignment","High-Resolution Output","Superior Typographic Rendering","Multi-Image Composition with Identity Preservation","Strong Structural Fidelity"].map((feature, index) => (
        <span key={index} className="falt-chip" style={{background: '#ff6b00', color: '#fff', padding: '8px 12px', borderRadius: '8px', fontFamily: 'googleSansFlex'}}>{feature}</span>
      ))}
    </div>
    <div className="falt-visual" style={{width: '100%', borderRadius: '12px', overflow: 'hidden'}}>
      <img src="/output/generated-assets/seedream-4-5-and-seedance-1-5-pro/12-5d90f4cffc.png" alt="Feature 1" style={{width: '100%', borderRadius: '12px', display: 'block'}} />
    </div>
  </div>
  
  <div className="falt-block reveal flip" style={{display: 'flex', flexDirection: 'column', margin: '20px 0', padding: '20px', background: '#ffffff', borderRadius: '12px'}}>
    <div className="falt-num" style={{fontSize: '28px', fontFamily: 'Plus Jakarta Sans', color: '#ff6b00', marginBottom: '10px'}}>02</div>
    <h3 style={{fontFamily: 'Plus Jakarta Sans', fontSize: '22px', color: '#000', margin: '0 0 10px'}}>AI Video Generation with Seedance 1.5 Pro by Bytedance</h3>
    <p style={{fontFamily: 'googleSansFlex', color: '#555', margin: '0 0 20px'}}>
    ...
    <div className="falt-chips" style={{display: 'flex', flexWrap: 'wrap', gap: '8px', marginBottom: '20px'}}>
      {["Text-to-Video Generation","Audio-Visual Synchronization","Multilingual Lip-Sync","Cinematic Camera Control","10× Faster Inference"].map((feature, index) => (
        <span key={index} className="falt-chip" style={{background: '#ff6b00', color: '#fff', padding: '8px 12px', borderRadius: '8px', fontFamily: 'googleSansFlex'}}>{feature}</span>
      ))}
    </div>
    <div className="falt-visual" style={{width: '100%', borderRadius: '12px', overflow: 'hidden'}}>
...
<section className="fig">
  <div className="fig-head" style={{position:'relative',background:'#ffffff',padding:'20px'}}>
    <div style={{position:'relative',zIndex:'1'}}>
      <span className="eyebrow" style={{color:'#ff6b00',fontSize:'14px',fontWeight:'bold',textTransform:'uppercase'}}>Features</span>
      <h2 style={{fontSize:'clamp(32px, 5vw, 60px)',fontWeight:'bold',marginBottom:'16px',color:'#333',wordBreak:'normal',overflowWrap:'normal',hyphens:'none'}}>Create High-Quality AI Images & Videos with ByteDance Generative Models</h2>
      <p style={{color:'#555',lineHeight:'1.6',marginBottom:'32px'}}>Unlock the power of next-generation generative AI with Seedream 4.5 (Image Generation) and Seedance 1.5 Pro (Video Generation) - advanced foundation models developed by ByteDance for high-quality visual content creation.</p>
    </div>
    <img src="/output/generated-assets/seedream-4-5-and-seedance-1-5-pro-by-bytedance/15-41ea7f7485.png" alt="Seedream 4.5 and Seedance 1.5 Pro" style={{width:'100%',height:'100%',objectFit:'cover',display:'block',position:'absolute',inset:0}}/>
  </div>
  <div className="fig-grid stagger-parent" style={{display:'flex',flexWrap:'wrap',gap:'20px',marginTop:'20px'}}>
    {[
      ...
      <div className="fig-card" style={{flex:'1 1 calc(33.333% - 20px)',minWidth:'250px',background:'#f8fafc',padding:'20px',borderRadius:'12px',position:'relative',opacity:'0',transform:'translateY(20px)',willChange:'opacity, transform',transition:'all 0.4s ease'}}>
        <div className="fig-icon" style={{marginBottom:'16px'}}>
          <svg width="16" height="16" fill="var(--accent)" xmlns="http://www.w3.org/2000/svg"><circle cx="8" cy="8" r="8"/></svg>
        </div>
        <h4 className="inline" style={{fontSize:'20px',marginBottom:'8px',color:'#333'}}>{feature.title}</h4>
        <p className="inline" style={{color:'#555'}}>{feature.description}</p>
      </div>
    ))}
  </div>
</section>

<section className="gvw" style={{backgroundColor: '#ffffff', padding: '60px 20px'}}>
  <div className="gvw-head" style={{textAlign: 'center', marginBottom: '40px'}}>
    <div className="eyebrow" style={{color: '#ff6b00', fontWeight: 'bold', fontSize: '16px'}}>Gallery Video Wall</div>
    <h2 style={{fontFamily: 'Plus Jakarta Sans', wordBreak: 'normal', overflowWrap: 'normal', hyphens: 'none', fontSize: 'clamp(32px,5vw,60px)', margin: '20px 0'}}>"Create High-Quality AI Images & Videos with ByteDance Generative Models"</h2>
    <p style={{fontFamily: 'googleSansFlex, "googleSansFlex Fallback"', color: '#6b7280', fontSize: '18px', lineHeight: '1.6'}}>Unlock the power of next-generation generative AI with Seedream 4.5 (Image Generation) and Seedance 1.5 Pro (Video Generation) - advanced foundation models developed by ByteDance for high-quality visual content creation.</p>
  </div>
  <div className="gvw-grid" style={{display: 'flex', flexWrap: 'wrap', gap: '20px'}}>
    <div className="gvw-card anim-scale" style={{flex: '1 0 calc(50% - 20px)', minWidth: '300px', position: 'relative', borderRadius: '12px', overflow: 'hidden'}}>
      <div className="gvw-video" style={{position: 'relative', width: '100%', paddingTop: '56.25%', height: '0', overflow: 'hidden'}}>
        <video autoPlay muted loop playsInline style={{position: 'absolute', top: '0', left: '0', width: '100%', height: '100%', objectFit: 'cover'}}>
          <source src="https://cdn.web.imagine.art/imagine-one/cdge/sora1.mp4" type="video/mp4"/>
        </video>
      </div>
      <div className="gvw-caption" style={{padding: '10px', backgroundColor: 'rgba(0,0,0,0.7)', color: '#ffffff', position: 'absolute', bottom: '0', width: '100%', textAlign: 'center'}}>Seedream 4.5</div>
    </div>
    <div className="gvw-card anim-scale" style={{flex: '1 0 calc(50% - 20px)', minWidth: '300px', position: 'relative', borderRadius: '12px', overflow: 'hidden'}}>
      <div className="gvw-video" style={{position: 'relative', width: '100%', paddingTop: '56.25%', height: '0', overflow: 'hidden'}}>
        <video autoPlay muted loop playsInline style={{position: 'absolute', top: '0', left: '0', width: '100%', height: '100%', objectFit: 'cover'}}>
      ...
      <div className="gvw-caption" style={{padding: '10px', backgroundColor: 'rgba(0,0,0,0.7)', color: '#ffffff', position: 'absolute', bottom: '0', width: '100%', textAlign: 'center'}}>Seedance 1.5 Pro</div>
    </div>
    <div className="gvw-card anim-scale" style={{flex: '1 0 calc(50% - 20px)', minWidth: '300px', position: 'relative', borderRadius: '12px', overflow: 'hidden'}}>
      <div className="gvw-video" style={{position: 'relative', width: '100%', paddingTop: '56.25%', height: '0', overflow: 'hidden'}}>
        <video autoPlay muted loop playsInline style={{position: 'absolute', top: '0', left: '0', width: '100%', height: '100%', objectFit: 'cover'}}>
      ...
      <div className="gvw-caption" style={{padding: '10px', backgroundColor: 'rgba(0,0,0,0.7)', color: '#ffffff', position: 'absolute', bottom: '0', width: '100%', textAlign: 'center'}}>Demo 3</div>
    </div>
    <div className="gvw-card anim-scale" style={{flex: '1 0 calc(50% - 20px)', minWidth: '300px', position: 'relative', borderRadius: '12px', overflow: 'hidden'}}>
      <div className="gvw-video" style={{position: 'relative', width: '100%', paddingTop: '56.25%', height: '0', overflow: 'hidden'}}>
        <video autoPlay muted loop playsInline style={{position: 'absolute', top: '0', left: '0', width: '100%', height: '100%', objectFit: 'cover'}}>
      ...
      <div className="gvw-caption" style={{padding: '10px', backgroundColor: 'rgba(0,0,0,0.7)', color: '#ffffff', position: 'absolute', bottom: '0', width: '100%', textAlign: 'center'}}>Demo 4</div>
    </div>
  </div>
</section>

<section className="wtj" style={{ backgroundColor: '#ffffff', padding: '60px 0' }}>
  <div className="wtj-inner" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative' }}>
    <div className="wtj-top" style={{ textAlign: 'center', marginBottom: '40px' }}>
      ...
      <p className="wtj-tagline" style={{ color: '#333', fontSize: '18px', marginBottom: '20px' }}>India's #1 B2B Software Marketplace</p>
      <div style={{ width: '100%', height: '300px', position: 'relative', overflow: 'hidden', borderRadius: '12px', marginBottom: '40px' }}>
        <img src="/output/generated-assets/seedream-4-5-and-seedance-1-5-pro-by-bytedance/15-41ea7f7485.png" alt="Seedream 4.5 and Seedance 1.5 Pro" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block', position: 'absolute', inset: 0 }} />
      </div>
      <div className="wtj-divider" style={{ borderTop: '2px solid #ddd', margin: '40px auto', width: '80%' }}></div>
    </div>
    <div className="wtj-grid stagger-parent" style={{ display: 'flex', justifyContent: 'space-between', gap: '20px', flexWrap: 'wrap' }}>
      <div className="wtj-card" style={{ flex: '1 1 45%', boxShadow: '0 4px 8px rgba(0,0,0,0.1)', padding: '20px', borderRadius: '12px', backgroundColor: '#f8fafc', marginBottom: '20px' }}>
        <div className="wtj-icon" style={{ marginBottom: '10px' }}>
          {/* SVG icon placeholder */}
          <svg width="24" height="24" viewBox="0 0 24 24" fill="#ff6b00"><circle cx="12" cy="12" r="10"></circle></svg>
        </div>
        <h4 style={{ color: '#333', fontSize: '20px', marginBottom: '10px' }}>Free Expert Consultation</h4>
        <p style={{ color: '#666', fontSize: '16px' }}>Get matched with right software</p>
      </div>
      <div className="wtj-card" style={{ flex: '1 1 45%', boxShadow: '0 4px 8px rgba(0,0,0,0.1)', padding: '20px', borderRadius: '12px', backgroundColor: '#f8fafc', marginBottom: '20px' }}>
        <div className="wtj-icon" style={{ marginBottom: '10px' }}>
          {/* SVG icon placeholder */}
        ...
        <h4 style={{ color: '#333', fontSize: '20px', marginBottom: '10px' }}>Verified Reviews</h4>
        <p style={{ color: '#666', fontSize: '16px' }}>1000+ genuine customer reviews</p>
      </div>
      <div className="wtj-card" style={{ flex: '1 1 45%', boxShadow: '0 4px 8px rgba(0,0,0,0.1)', padding: '20px', borderRadius: '12px', backgroundColor: '#f8fafc', marginBottom: '20px' }}>
        <div className="wtj-icon" style={{ marginBottom: '10px' }}>
          {/* SVG icon placeholder */}
        ...
        <h4 style={{ color: '#333', fontSize: '20px', marginBottom: '10px' }}>Best Price Guarantee</h4>
        <p style={{ color: '#666', fontSize: '16px' }}>Competitive pricing assured</p>
      </div>
      <div className="wtj-card" style={{ flex: '1 1 45%', boxShadow: '0 4px 8px rgba(0,0,0,0.1)', padding: '20px', borderRadius: '12px', backgroundColor: '#f8fafc', marginBottom: '20px' }}>
        <div className="wtj-icon" style={{ marginBottom: '10px' }}>
          {/* SVG icon placeholder */}
        ...
        <h4 style={{ color: '#333', fontSize: '20px', marginBottom: '10px' }}>Dedicated Support</h4>
        <p style={{ color: '#666', fontSize: '16px' }}>Post-sale onboarding assistance</p>
      </div>
    </div>
  </div>
</section>

<section className="pdc" style={{backgroundColor:'#ffffff',padding:'60px 30px',position:'relative'}}>
  <div className="pdc-head anim d0" style={{textAlign:'center', marginBottom:'40px'}}>
    <h2 style={{color:'#333',fontSize:'clamp(32px,5vw,60px)',fontWeight:'bold',marginBottom:'10px'}}>Create High-Quality AI Images & Videos with ByteDance Generative Models</h2>
    <span className="eyebrow" style={{color:'#ff6b00',fontWeight:'600'}}>Pricing Plans</span>
  </div>
  <div className="pdc-grid stagger-parent" style={{display:'flex',flexWrap:'wrap',justifyContent:'center',gap:'20px'}}>
    {/* Seedream 4.5 Plan */}
    <div className="pdc-card featured" style={{flex:'1 1 calc(50% - 20px)',maxWidth:'480px',backgroundColor:'#f8fafc',borderRadius:'12px',padding:'20px',position:'relative',boxShadow:'0 4px 10px rgba(0,0,0,0.1)'}}>
      <div className="pdc-badge" style={{position:'absolute',top:'-10px',right:'-10px',background:'#ff6b00',color:'#fff',borderRadius:'12px',padding:'5px 10px',fontWeight:'600'}}>Special Offer</div>
      <h3 className="pdc-plan" style={{fontSize:'22px',fontWeight:'bold',marginBottom:'20px'}}>Seedream 4.5 (AI Image Generation)</h3>
      <div className="pdc-price" style={{marginBottom:'20px'}}>
        <span className="pdc-amount" style={{color:'#333',fontSize:'28px',fontWeight:'bold'}}>Contact for Pricing</span>
        <span className="pdc-period" style={{display:'block',color:'#777',fontSize:'18px'}}>per user/month</span>
      </div>
      <p className="pdc-desc" style={{color:'#555',marginBottom:'20px'}}>Advanced image generation with high fidelity and typographic excellence.</p>
      <ul className="pdc-list" style={{listStyleType:'none',padding:'0'}}>
        <li className="pdc-check" style={{display:'flex',alignItems:'center',marginBottom:'10px'}}>
          <svg width="16" height="16" fill="#ff6b00" style={{marginRight:'8px'}}>
            <path d="M12 5l-6 6-2.5-2.5L5 8l3 3L14 4l-2-2z" />
          </svg>
    ...
    {/* Seedance 1.5 Pro Plan */}
    <div className="pdc-card" style={{flex:'1 1 calc(50% - 20px)',maxWidth:'480px',backgroundColor:'#f8fafc',borderRadius:'12px',padding:'20px',position:'relative',boxShadow:'0 4px 10px rgba(0,0,0,0.1)'}}>
      <h3 className="pdc-plan" style={{fontSize:'22px',fontWeight:'bold',marginBottom:'20px'}}>Seedance 1.5 Pro (AI Video Generation)</h3>
      <div className="pdc-price" style={{marginBottom:'20px'}}>
        <span className="pdc-amount" style={{color:'#333',fontSize:'28px',fontWeight:'bold'}}>Starting at $1,000/month/</span>
        <span className="pdc-period" style={{display:'block',color:'#777',fontSize:'18px'}}>per user/month</span>
      </div>
      <p className="pdc-desc" style={{color:'#555',marginBottom:'20px'}}>Cinematic video generation with native audio support and fast processing.</p>
      <ul className="pdc-list" style={{listStyleType:'none',padding:'0'}}>
        <li className="pdc-check" style={{display:'flex',alignItems:'center',marginBottom:'10px'}}>
          <svg width="16" height="16" fill="#ff6b00" style={{marginRight:'8px'}}>
            <path d="M12 5l-6 6-2.5-2.5L5 8l3 3L14 4l-2-2z" />
...
<section className="tcar" style={{ backgroundColor: '#ffffff', padding: '60px 0' }}>
  <div className="container">
    <div className={`tcar-head anim d0`} style={{ textAlign: 'center' }}>
      <p className="eyebrow" style={{ color: '#ff6b00', marginBottom: '16px', fontSize: '18px' }}>Testimonials</p>
      <h2 style={{ fontSize: 'clamp(32px, 5vw, 60px)', wordBreak: 'normal', overflowWrap: 'normal', hyphens: 'none', marginBottom: '24px' }}>
        Create High-Quality AI Images & Videos with ByteDance Generative Models
      </h2>
      <p style={{ maxWidth: '600px', margin: '0 auto', fontSize: '16px', lineHeight: '1.5', color: '#333' }}>
    ...
    <div className="tcar-layout" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '40px' }}>
      <div className={`tcar-stage anim-scale d1`} style={{ overflow: 'hidden', width: '100%', maxWidth: '800px', margin: '0 auto' }}>
        <div className="tcar-track" style={{ display: 'flex', transform: `translateX(${slide * -100}%)`, transition: 'transform 0.5s' }}>
          {[
            {"quote":"Seedream allows us to generate high-resolution creative visuals from simple prompts. It has dramatically reduced our design turnaround time.","author":"Vaishali Saxena","role":"Creative Director","avatar":"/output/generated-assets/seedream-4-5-and-seedance-1-5-pro/06-6d75b26b02.webp"},
            {"quote":"Seedance’s ability to generate synchronized audio and video is incredibly powerful for storytelling and branded content.","author":"Vihaan Pandey","role":"Video Producer","avatar":"/output/generated-assets/seedream-4-5-and-seedance-1-5-pro/17-761b0d7272.webp"},
            {"quote":"The multimodal editing capabilities in Seedream make it easy to refine images with precision.","author":"Anurag Malhotra","role":"Art Director","avatar":"/output/generated-assets/seedream-4-5-and-seedance-1-5-pro/18-67afb8c98a.webp"},
            {"quote":"Techjockey made it easy to evaluate Seedream (AI Image Generation) and Seedance (AI Video Generation). The free demo helped us clearly understand the capabilities before making a decision.","author":"Ashutosh Singh","role":"Marketing Manager","avatar":"/output/generated-assets/seedream-4-5-and-seedance-1-5-pro/19-0518458b81.webp"},
            ...
            <div key={index} className="tcar-slide" style={{ minWidth: '100%', boxSizing: 'border-box', padding: '20px' }}>
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <img className="tcar-avatar" src={testimonial.avatar || '/static/avatar-placeholder.png'} alt={testimonial.author} style={{ width: '72px', height: '72px', borderRadius: '50%', marginRight: '20px' }} />
                <div>
                  <div className="tcar-quote" style={{ marginBottom: '12px' }}>
                    <p className="tcar-text" style={{ fontSize: '16px', color: '#333', lineHeight: '1.5' }}>
                      "{testimonial.quote}"
                    </p>
                  </div>
                  <div className="tcar-author" style={{ fontSize: '14px', color: '#777' }}>
                    <p className="tcar-name" style={{ margin: '0' }}>{testimonial.author}</p>
                    <p className="tcar-role" style={{ margin: '0' }}>{testimonial.role}</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="tcar-dots" style={{ display: 'flex', justifyContent: 'center', marginTop: '20px' }}>
        {Array.from({ length: 5 }).map((_, index) => (
          <div key={index} className={`tcar-dot ${index === slide ? 'active' : ''}`} style={{ width: '12px', height: '12px', borderRadius: '50%', background: index === slide ? '#ff6b00' : '#ddd', margin: '0 4px' }}></div>
        ))}
      </div>
      <div className="tcar-rail" style={{ display: 'flex', gap: '20px', marginTop: '40px', overflowX: 'auto', width: '100%', maxWidth: '800px' }}>
        {[
          {"quote":"Seedream allows us to generate high-resolution creative visuals from simple prompts. It has dramatically reduced our design turnaround time.","author":"Vaishali Saxena","role":"Creative Director","avatar":"/output/generated-assets/seedream-4-5-and-seedance-1-5-pro/06-6d75b26b02.webp"},
          {"quote":"Seedance’s ability to generate synchronized audio and video is incredibly powerful for storytelling and branded content.","author":"Vihaan Pandey","role":"Video Producer","avatar":"/output/generated-assets/seedream-4-5-and-seedance-1-5-pro/17-761b0d7272.webp"},
          {"quote":"The multimodal editing capabilities in Seedream make it easy to refine images with precision.","author":"Anurag Malhotra","role":"Art Director","avatar":"/output/generated-assets/seedream-4-5-and-seedance-1-5-pro/18-67afb8c98a.webp"}
        ].map((testimonial, index) => (
          <div key={index} className="tcar-mini" style={{ flex: '0 0 auto', width: '200px', padding: '20px', background: '#f8fafc', borderRadius: '12px' }}>
            <div style={{ fontSize: '14px', color: '#333', lineHeight: '1.5', maxHeight: '3em', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
              "{testimonial.quote}"
            </div>
            <div style={{ display: 'flex', alignItems: 'center', marginTop: '12px' }}>
              <img className="tcar-avatar" src={testimonial.avatar || '/static/avatar-placeholder.png'} alt={testimonial.author} style={{ width: '32px', height: '32px', borderRadius: '50%', marginRight: '8px' }} />
              <div>
                <p className="tcar-name" style={{ fontSize: '12px', margin: '0', color: '#555' }}>{testimonial.author}</p>
                <p className="tcar-role" style={{ fontSize: '12px', margin: '0', color: '#999' }}>{testimonial.role}</p>
              </div>
            </div>
          </div>
        ))}
...
<section className="ctavb" style={{position:'relative',overflow:'hidden'}}>
  ...
  <div className="ctavb-inner" style={{position:'relative',zIndex:1,display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',height:'100vh',padding:'2rem',textAlign:'center'}}>
    <h2 className="anim d0" style={{color:'#ffffff',fontSize:'clamp(32px, 5vw, 60px)',fontFamily:'Plus Jakarta Sans',fontWeight:'bold',marginBottom:'1rem'}}>Create High-Quality AI Images & Videos with ByteDance Generative Models</h2>
    <p className="anim d1" style={{color:'#ffffff',fontSize:'1rem',lineHeight:1.5,fontFamily:'googleSansFlex, "googleSansFlex Fallback"',marginBottom:'2rem'}}>Unlock the power of next-generation generative AI with Seedream 4.5 (Image Generation) and Seedance 1.5 Pro (Video Generation) - advanced foundation models developed by ByteDance for high-quality visual content creation.</p>
    <a className="ctavb-btn anim d2" href="#lead-form" style={{backgroundColor:'#ff6b00',color:'#ffffff',padding:'0.75rem 1.5rem',textDecoration:'none',borderRadius:'8px',fontFamily:'googleSansFlex, "googleSansFlex Fallback"',fontWeight:'bold'}}>Generate with AI</a>
  </div>
  <img src="/output/generated-assets/seedream-4-5-and-seedance-1-5-pro-by-bytedance/15-41ea7f7485.png" alt="Seedream 4.5 and Seedance 1.5 Pro" style={{width:'100%',height:'100%',objectFit:'cover',display:'block',position:'absolute',inset:0}}/>
</section>
