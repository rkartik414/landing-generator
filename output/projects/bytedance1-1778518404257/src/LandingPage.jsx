      ...
      <section className="safe-hero">
        ...
        <section className="safe-section ">
          <div className="safe-container">
            ...
            <p className="safe-desc">Seedream 4.5 is a high-performance multimodal image generation system designed to produce high-resolution, high-fidelity images from text prompts and visual inputs.
The model unifies text-to-image synthesis, image editing, and multi-image composition within a single framework.</p>
        ...
        <section className="safe-section safe-section-alt">
          <div className="safe-container">
            ...
            <p className="safe-desc">Seedance 1.5 Pro is a next-generation generative model designed for native audio-visual generation, enabling synchronized creation of video and sound together.
Built on a dual-branch diffusion transformer architecture, the model integrates cross-modal learning to produce coherent visual and audio outputs.</p>
            <ul className="safe-feature-list">
              <li>
