  ...
  return (
    <div>
     ...
     <nav className="sticky top-0 z-50 bg-gray-900/90 backdrop-blur-xl border-b border-white/10 py-3.5">
      ...
      <section class="hvf" style={{height: '100vh', overflow: 'hidden', position: 'relative'}}>
  <video autoPlay muted loop playsInline className="hvf-video" style={{width:'100%',height:'100%',objectFit:'cover',display:'block',position:'absolute',inset:0}}>
    <source src="https://cdn.web.imagine.art/imagine-one/cdge/sora1.mp4" type="video/mp4"/>
  </video>
  <div className="hvf-overlay" style={{background: 'rgba(0,0,0,0.5)', position: 'absolute', inset: 0}}></div>
  <div className="hvf-content" style={{position: 'relative', zIndex: 2}}>
    <div className="hvf-inner" style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '100%', maxWidth: '1200px', margin: '0 auto', padding: '0 20px'}}>
      <div style={{maxWidth: '600px'}}>
        <h1 className="hvf-h1 anim d0" style={{color: '#fff', fontSize: 'clamp(32px, 5vw, 60px)', fontFamily: 'Inter', marginBottom: '20px'}}>
          Create High-Quality AI Images & Videos with <span className="hvf-accent">Seedream 4.5 and Seedance 1.5 Pro</span> Generative Models
        </h1>
        <p className="hvf-desc anim d1" style={{color: '#fff', fontSize: '18px', lineHeight: '1.6', marginBottom: '30px'}}>
        ...
        <div className="hvf-chips" style={{display: 'flex', gap: '8px', marginBottom: '40px'}}>
          {["Seedream 4.5 (AI Image Generation)", "Seedance 1.5 Pro (AI Video Generation)"].map((chip, index) => (
            <div key={index} className="hvf-chip" style={{backgroundColor: '#ff6b00', color: '#fff', padding: '10px 20px', borderRadius: '20px'}}>{chip}</div>
          ))}
        </div>
        <button className="hvf-btn" style={{backgroundColor: '#ff6b00', color: '#fff', padding: '15px 30px', borderRadius: '30px', fontFamily: 'Inter', fontSize: '16px', cursor: 'pointer'}}>
          Generate with AI
        </button>
      </div>
      <div className="hvf-inner" style={{maxWidth: '500px', background: '#ffffff', padding: '40px', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.1)'}}>
        <form>
          <div className="hvf-pill anim d2" style={{marginBottom: '20px'}}>
            <input type="text" placeholder="Name" style={{width: '100%', padding: '12px 20px', marginBottom: '10px', borderRadius: '25px', border: '1px solid #ddd', fontFamily: 'googleSansFlex, sans-serif'}}/>
            <input type="email" placeholder="Email" style={{width: '100%', padding: '12px 20px', marginBottom: '10px', borderRadius: '25px', border: '1px solid #ddd', fontFamily: 'googleSansFlex, sans-serif'}}/>
            <input type="tel" placeholder="Phone" style={{width: '100%', padding: '12px 20px', marginBottom: '10px', borderRadius: '25px', border: '1px solid #ddd', fontFamily: 'googleSansFlex, sans-serif'}}/>
            <input type="text" placeholder="Company" style={{width: '100%', padding: '12px 20px', marginBottom: '20px', borderRadius: '25px', border: '1px solid #ddd', fontFamily: 'googleSansFlex, sans-serif'}}/>
            <button type="submit" style={{width: '100%', backgroundColor: '#ff6b00', color: '#fff', padding: '15px 0', borderRadius: '30px', fontSize: '16px', fontFamily: 'Inter'}}>Submit</button>
          </div>
        </form>
      </div>
    </div>
    <div className="hvf-proof" style={{position: 'absolute', bottom: '20px', width: '100%', textAlign: 'center', zIndex: 2}}>
      <div className="hvf-avatars" style={{marginBottom: '10px'}}>
        {Array(4).fill().map((_, idx) => (
          <span key={idx} className="hvf-av" style={{display: 'inline-block', backgroundColor: `hsl(${idx * 90}, 70%, 50%)`, width: '40px', height: '40px', borderRadius: '50%', marginLeft: '-8px', border: '3px solid #fff'}}/>
        ))}
      </div>
      <div className="hvf-stars" style={{display: 'inline-block'}}>
        {Array(5).fill().map((_, idx) => (
          <svg viewBox="0 0 20 20" width="20" height="20" key={idx} style={{fill: '#FFD700'}}>
            <polygon points="9.9,1.38 12.3,6.63 18,7.07 14,11.1 15,17 9.9,14.1 5,17 6,11.1 2,7.07 7.7,6.63"/>
          </svg>
        ))}
      </div>
    </div>
...
<section className="tms" style={{backgroundColor: '#f8fafc'}}>
  <div className="tms-grid">
    <div className="tms-cell reveal anim d0">
      <div className="tms-val" data-count="2500">2,500+</div>
      <div className="tms-label">Projects Delivered</div>
      <div className="tms-note">High-quality visual content produced</div>
    </div>
    <div className="tms-cell reveal anim d1">
      <div className="tms-val" data-count="150">150+</div>
      <div className="tms-label">Global Clients</div>
      <div className="tms-note">Worldwide satisfied partners</div>
    </div>
    <div className="tms-cell reveal anim d2">
      <div className="tms-val" data-count="50000">50,000+</div>
      <div className="tms-label">AI Model Iterations</div>
      <div className="tms-note">Constant improvements and updates</div>
    </div>
  </div>
  <img src="/output/generated-assets/ds_1778241785252_ee9a271b/07-c4e1793d4f.webp" alt="Seedream 4.5 and Seedance 1.5 Pro" style={{width:'100%',height:'100%',objectFit:'cover',display:'block',position:'absolute',inset:0}}/>
</section>
  ...
  {[
    {
      ...
      image_url: "/output/generated-assets/ds_1778241785252_ee9a271b/12-581339b7d2.png",
      video_url: ""
    },
    {
      num: "02",
      ...
      image_url: "/output/generated-assets/ds_1778241785252_ee9a271b/15-41ea7f7485.png",
      video_url: ""
    }
  ].map((section, index) => (
...
<section className="mns" style={{position:'relative',backgroundColor:'#ffffff',padding:'40px 0'}}>
  <div className="mns-head" style={{textAlign:'center',marginBottom:'20px'}}>
    <h2 className="mns-label" style={{color:'#ff6b00',fontWeight:'bold'}}>FEATURES</h2>
  </div>
  <div className="mns-grid" style={{display:'flex',gap:'20px',justifyContent:'center'}}>
    {[{publication:'TechCrunch', headline:'"Seedream 4.5 brings innovative image generation technology to the forefront."'},
      {publication:'Wired', headline:'"Experience next-level video production with Seedance 1.5 Pro."'},
      {publication:'Forbes', headline:'"ByteDance’s generative models redefine creative processes."'}].map((item, index) => (
      <div key={index} className="mns-card" style={{flex:'1 1 0',maxWidth:'30%',padding:'20px',border:'1px solid #ddd',borderRadius:'12px',boxShadow:'0 4px 8px rgba(0,0,0,0.1)',transition:'transform 0.3s',cursor:'pointer'}} onMouseEnter={e => e.currentTarget.style.transform='scale(1.05)'} onMouseLeave={e => e.currentTarget.style.transform='scale(1)'}>
        <div className="mns-pub" style={{fontSize:'16px',fontWeight:'500',marginBottom:'10px'}}>{item.publication}</div>
        <div className="mns-text" style={{fontSize:'14px',color:'#555'}}>{item.headline}</div>
      </div>
    ))}
  </div>
  <div style={{margin:'40px auto',maxWidth:'80%',position:'relative',overflow:'hidden',borderRadius:'12px'}}>
    <img src="/output/generated-assets/ds_1778241785252_ee9a271b/07-c4e1793d4f.webp" alt="Seedream 4.5 and Seedance 1.5 Pro" style={{width:'100%',height:'100%',objectFit:'cover',display:'block',position:'absolute',inset:0}}/>
  </div>
  <div className="mns-grid" style={{display:'flex',gap:'20px',justifyContent:'center',marginTop:'40px'}}>
    <img src="/output/generated-assets/ds_1778241785252_ee9a271b/12-581339b7d2.png" alt="Feature 1" style={{width:'100%',borderRadius:'12px',display:'block'}}/>
    <img src="/output/generated-assets/ds_1778241785252_ee9a271b/15-41ea7f7485.png" alt="Feature 2" style={{width:'100%',borderRadius:'12px',display:'block'}}/>
  </div>
</section>
...
<section className="fig">
  <div className="fig-head">
    <div className="eyebrow">Features</div>
    <h2 className="text-xl font-bold mb-4">Create High-Quality AI Images & Videos with ByteDance Generative Models</h2>
    <p className="mb-6">Unlock the power of next-generation generative AI with Seedream 4.5 (Image Generation) and Seedance 1.5 Pro (Video Generation) - advanced foundation models developed by ByteDance for high-quality visual content creation.</p>
    <div style={{position:'relative',width:'100%',height:'200px',marginBottom:'24px'}}>
      <img src="/output/generated-assets/ds_1778241785252_ee9a271b/07-c4e1793d4f.webp" alt="Seedream 4.5 and Seedance 1.5 Pro" style={{width:'100%',height:'100%',objectFit:'cover',display:'block',position:'absolute',inset:0}}/>
    </div>
  </div>
  <div className="fig-grid grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 stagger-parent">
    {[{"title":"Advanced Text–Image Alignment","description":"Accurately translates prompts into visuals with improved semantic understanding."},{"title":"High-Resolution Output","description":"Generate native images up to 1K–4K resolution with strong visual fidelity."},{"title":"Superior Typographic Rendering","description":"Optimized for posters, ads, and text-heavy visual designs."},{"title":"Multi-Image Composition with Identity Preservation","description":"Combines multiple inputs while accurately maintaining subject consistency."},{"title":"Strong Structural Fidelity","description":"Maintains composition, layout, and scene structure with high precision."},{"title":"Key Capabilities of Seedance 1.5 Pro","description":"Seedance enables professional-grade AI video production with narrative coherence and realistic motion."}].map((feature, i) => (
      <div key={i} className="fig-card flex items-start space-x-4 opacity-0 translate-y-5">
        <div className="fig-icon w-4 h-4" style={{backgroundColor:'var(--accent)'}}>
          {/* Placeholder SVG - replace with specific icon */}
...
<section className="gvw bg-[#f8fafc] py-16">
  <div className="gvw-head text-center mb-12">
    <span className="eyebrow text-[#ff6b00] font-medium">Feature Gallery</span>
    <h2 className="text-4xl font-bold mt-4" style={{ fontFamily: 'Inter, sans-serif' }}>Create High-Quality AI Images & Videos with ByteDance Generative Models</h2>
    <p className="text-lg mt-4" style={{ fontFamily: 'googleSansFlex, "googleSansFlex Fallback"' }}>
      Unlock the power of next-generation generative AI with Seedream 4.5 (Image Generation) and Seedance 1.5 Pro (Video Generation) - advanced foundation models developed by ByteDance for high-quality visual content creation.
    </p>
  </div>
  <div className="gvw-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-6">
    {[
      {"url":"https://cdn.web.imagine.art/imagine-one/cdge/sora1.mp4","caption":"Seedream 4.5 (AI Image Generation)"},
      {"url":"https://cdn.web.imagine.art/imagine-one/cdge/sora2.mp4","caption":"Seedance 1.5 Pro (AI Video Generation)"},
      ...
      <div key={index} className="gvw-card relative overflow-hidden rounded-xl shadow-lg anim-scale">
        <video className="gvw-video" autoPlay muted loop playsInline style={{ width: '100%', display: 'block', borderRadius: '12px' }}>
          <source src={video.url} type="video/mp4" />
        </video>
        <div className="gvw-caption absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 text-white p-4 text-center">
          {video.caption}
        </div>
      </div>
    ))}
  </div>
  <div className="relative mt-12" style={{ height: '400px', borderRadius: '12px' }}>
    <img src="/output/generated-assets/ds_1778241785252_ee9a271b/07-c4e1793d4f.webp" alt="Seedream 4.5 and Seedance 1.5 Pro" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block', position: 'absolute', inset: 0 }} />
  </div>
</section>
...
<section className="wtj" style={{ backgroundColor: '#ffffff', padding: '40px' }}>
  <div className="wtj-inner max-w-6xl mx-auto">
    <div className="wtj-top flex items-center justify-between mb-8">
      ...
      <span className="wtj-tagline text-lg text-[#ff6b00]">India's #1 B2B Software Marketplace</span>
    </div>
    <div className="wtj-divider h-px bg-gray-200 my-8"></div>
    <div className="relative aspect-w-16 aspect-h-9 mb-8">
      <img src="/output/generated-assets/ds_1778241785252_ee9a271b/07-c4e1793d4f.webp" alt="Seedream 4.5 and Seedance 1.5 Pro" style={{width:'100%',height:'100%',objectFit:'cover',display:'block',position:'absolute',inset:0}}/>
    </div>
    <div className="wtj-tagline text-xl font-semibold text-center mb-12">
      Why Choose Techjockey?
    </div>
    <div className="wtj-grid grid grid-cols-1 md:grid-cols-2 gap-8 reveal anim stagger">
      {[
        ...
        <div key={index} className="wtj-card flex items-start p-6 bg-white shadow-md rounded-lg">
          <div className="wtj-icon mr-4">
            <svg className="text-[#ff6b00]" width="24" height="24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 0l3.09 6.26L22 7.27l-5 4.87L18.18 22 12 18.27 5.82 22l1.18-9.86-5-4.87 6.91-1.01L12 0z"/>
            </svg>
          </div>
          <div>
...
<section className="pdc">
  ...
  <div className="pdc-grid" style={{ display: 'grid', gap: '2rem' }}>
    {[
      {
      ...
      <div
        key={index}
        className={`pdc-card ${plan.highlighted ? "featured" : ""} reveal anim d0`}
      >
        {plan.discount && (
          <div className="pdc-badge">{plan.discount}</div>
        )}
        <div className="pdc-plan">{plan.name}</div>
        <div className="pdc-price">
          <span className="pdc-amount">
            {plan.price ? plan.price : "Contact for Pricing"}
          </span>
          {plan.originalPrice && <span className="pdc-old">{plan.originalPrice}</span>}
          <span className="pdc-period">{plan.period}</span>
        </div>
        <div className="pdc-desc">{plan.description}</div>
        <ul className="pdc-list">
          {plan.includes.map((item, i) => (
            <li key={i} className="pdc-check">
              <svg
        ...
        <button className="pdc-btn">Generate with AI</button>
      </div>
    ))}
  </div>
  <div className="pdc-media">
    <img
      src="/output/generated-assets/ds_1778241785252_ee9a271b/07-c4e1793d4f.webp"
    ...
    return (
      <>
        <div className="tcar-head text-center anim d0">
          <p className="eyebrow text-sm">Testimonials</p>
          <h2 className="hero-headline font-bold text-[#ff6b00]" style={{fontFamily:'Inter',fontSize:'clamp(32px,5vw,60px)'}}>Create High-Quality AI Images & Videos with ByteDance Generative Models</h2>
          <p className="hero-description text-base" style={{fontFamily:'googleSansFlex'}}>Unlock the power of next-generation generative AI with Seedream 4.5 (Image Generation) and Seedance 1.5 Pro (Video Generation) - advanced foundation models developed by ByteDance for high-quality visual content creation.</p>   
        </div>

        <div className="tcar-layout flex flex-col items-center mt-6">
          <div className="tcar-rail flex gap-4 mb-6">
            {[
              {quote: "Seedream allows us to generate high-resolution creative visuals from simple prompts. It has dramatically reduced our design turnaround time.", author: "Vaishali Saxena", role: "Creative Director", avatar: "/output/generated-assets/ds_1778241785252_ee9a271b/10-761b0d7272.webp"},
              {quote: "Seedance’s ability to generate synchronized audio and video is incredibly powerful for storytelling and branded content.", author: "Vihaan Pandey", role: "Video Producer", avatar: "/output/generated-assets/ds_1778241785252_ee9a271b/06-6d75b26b02.webp"},
              {quote: "The multimodal editing capabilities in Seedream make it easy to refine images with precision.", author: "Anurag Malhotra", role: "Art Director", avatar: "/output/generated-assets/ds_1778241785252_ee9a271b/17-67afb8c98a.webp"},
            ].map((t, i) => (
              <div key={i} className="tcar-mini">
                <img src={t.avatar} alt={t.author} className="tcar-mini-avatar w-10 h-10 rounded-full" />
                <div className="tcar-mini-text text-sm mt-2">
                  <p className="tcar-mini-quote">{t.quote.slice(0, 60)}...</p>
                  <p className="tcar-mini-author">{t.author}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="tcar-stage anim-scale d1">
            <div className="tcar-track" style={{transform:`translateX(-${slide*100}%)`}}>
              {[
                {quote: "Seedream allows us to generate high-resolution creative visuals from simple prompts. It has dramatically reduced our design turnaround time.", author: "Vaishali Saxena", role: "Creative Director", company:"", avatar: "/output/generated-assets/ds_1778241785252_ee9a271b/10-761b0d7272.webp"},
                {quote: "Seedance’s ability to generate synchronized audio and video is incredibly powerful for storytelling and branded content.", author: "Vihaan Pandey", role: "Video Producer", company:"", avatar: "/output/generated-assets/ds_1778241785252_ee9a271b/06-6d75b26b02.webp"},
                {quote: "The multimodal editing capabilities in Seedream make it easy to refine images with precision.", author: "Anurag Malhotra", role: "Art Director", company:"", avatar: "/output/generated-assets/ds_1778241785252_ee9a271b/17-67afb8c98a.webp"},
                {quote: "Techjockey made it easy to evaluate Seedream (AI Image Generation) and Seedance (AI Video Generation). The free demo helped us clearly understand the capabilities before making a decision.", author: "Ashutosh Singh", role: "Marketing Manager", company:"", avatar: "/output/generated-assets/ds_1778241785252_ee9a271b/18-0518458b81.webp"},
                ...
                <div key={i} className="tcar-slide" style={{minWidth:'100%'}}>
                  <div className="tcar-quote p-6 bg-white shadow-lg rounded-lg">
                    <p className="tcar-text italic mb-4">"{t.quote}"</p>
                    <div className="flex items-center">
                      <img src={t.avatar} alt={t.author} className="tcar-avatar w-12 h-12 rounded-full" />
                      <div className="ml-4">
                        <p className="tcar-name font-semibold">{t.author}</p>
                        <p className="tcar-role text-sm text-gray-600">{t.role}</p>
                      </div>
                    </div>
                    <div className="tcar-stars mt-2">
                      <span className="tcar-mini-stars">★★★★★</span>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="tcar-dots flex justify-center gap-2 mt-5">
            {[0,1,2,3,4].map(i => (
              <button key={i} className={`tcar-dot w-3 h-3 rounded-full ${i===slide ? 'bg-[#ff6b00]' : 'bg-gray-300'}`} onClick={() => setSlide(i)} />
            ))}
          </div>
        </div>
...
<section className="ctavb">
  ...
  <div className="ctavb-inner text-center px-6 py-12">
    <h2 className="reveal anim d0 text-4xl font-bold text-gray-900">{`Create High-Quality AI Images & Videos with ByteDance Generative Models`}</h2>
    <p className="reveal anim d1 mt-4 text-lg text-gray-700">{`Unlock the power of next-generation generative AI with Seedream 4.5 (Image Generation) and Seedance 1.5 Pro (Video Generation) - advanced foundation models developed by ByteDance for high-quality visual content creation.`}</p>
    <a href="#lead-form" className="ctavb-btn reveal anim d2 mt-6 inline-block px-5 py-3 bg-[#ff6b00] text-white font-semibold rounded-md">{`Generate with AI`}</a>
  </div>
</section>
