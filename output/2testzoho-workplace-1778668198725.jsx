...
<section className="tlg" style={{ background: '#ffffff', padding: '60px 20px', textAlign: 'center' }}>
  <div className="tlg-label" style={{ marginBottom: '40px', fontSize: '24px', color: '#1a1a1a', fontFamily: 'Inter' }}>
    Trusted by 100,000+ Businesses Globally
  </div>
  <div className="tlg-logos" style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '30px' }}>
  ...
  <div style={{ position: 'relative', width: '100%', paddingTop: '56.25%', marginTop: '40px' }}>
    <img src="/output/generated-assets/zoho-workplace/27-9026080137.png" alt="Zoho Workplace" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block', position: 'absolute', inset: 0 }} />
  </div>
</section>

<section className="falt" style={{backgroundColor: '#ffffff', padding: '50px 0'}}>
  <div className="container">
    <div className="falt-head anim d0" style={{textAlign: 'center', marginBottom: '50px'}}>
      <h2 style={{color: '#1a1a1a', fontFamily: 'Inter', fontSize: 'clamp(32px, 5vw, 60px)', lineHeight: '1.2', marginBottom: '20px'}}>Elevate Your Team’s Productivity with Zoho Workplace</h2>
    </div>
    <div className="reveal stagger-parent">
      <div className="falt-block" style={{padding: '20px 0', display: 'flex', alignItems: 'center', flexWrap: 'wrap'}}>
        <div className="falt-num" style={{fontSize: '24px', fontWeight: 'bold', marginRight: '20px'}}>01</div>
        <div style={{flex: '1'}}>
          <h3 style={{color: '#1a1a1a', fontFamily: 'Inter', marginBottom: '10px'}}>Why Choose Zoho Workplace?</h3>
          <p style={{margin: '0 0 10px', fontFamily: 'Zoho_Puvi_Regular, sans-serif', color: '#6b6b6b'}}>Zoho Workplace brings everything your team needs to collaborate, communicate, and stay productive through a single unified platform.</p>
          <div className="falt-chips" style={{display: 'flex', flexWrap: 'wrap', gap: '10px'}}>
            {["All-in-One Unified Workspace","Seamless Collaboration in Real Time","Work from Anywhere, Anytime","AI-Powered Productivity (Zia)"].map((feature, index) => (
              <div key={index} className="falt-chip" style={{backgroundColor: '#f8fafc', padding: '5px 10px', borderRadius: '20px', fontFamily: 'Zoho_Puvi_Regular, sans-serif', color: '#1a1a1a'}}>{feature}</div>
            ))}
          </div>
        </div>
        <div className="falt-visual" style={{flex: '1', marginLeft: '20px'}}>
          <img src="/output/generated-assets/zoho-workplace/18-473c14de05.jpg" alt="Feature 1" style={{width:'100%',borderRadius:'12px',display:'block'}}/>
        </div>
      </div>
      <div className="falt-block flip" style={{padding: '20px 0', display: 'flex', alignItems: 'center', flexWrap: 'wrap'}}>
        <div className="falt-num" style={{fontSize: '24px', fontWeight: 'bold', marginRight: '20px'}}>02</div>
        <div style={{flex: '1'}}>
          <h3 style={{color: '#1a1a1a', fontFamily: 'Inter', marginBottom: '10px'}}>Unlock Your Business Growth with Zoho Workplace</h3>
          <p style={{margin: '0 0 10px', fontFamily: 'Zoho_Puvi_Regular, sans-serif', color: '#6b6b6b'}}>Zoho Workplace unifies email, collaboration, and productivity tools to streamline your business operations. Enable smarter teamwork and drive growth with a single platform.</p>
          <div className="falt-chips" style={{display: 'flex', flexWrap: 'wrap', gap: '10px'}}>
        ...
        <div className="falt-visual" style={{flex: '1', marginLeft: '20px'}}>
          <img src="/output/generated-assets/zoho-workplace/31-89ce3cb959.jpeg" alt="Feature 2" style={{width:'100%',borderRadius:'12px',display:'block'}}/>
        </div>
      </div>
      <div className="falt-block" style={{padding: '20px 0', display: 'flex', alignItems: 'center', flexWrap: 'wrap'}}>
        <div className="falt-num" style={{fontSize: '24px', fontWeight: 'bold', marginRight: '20px'}}>03</div>
        <div style={{flex: '1'}}>
          <h3 style={{color: '#1a1a1a', fontFamily: 'Inter', marginBottom: '10px'}}>Integrate with Popular Apps</h3>
          <p style={{margin: '0 0 10px', fontFamily: 'Zoho_Puvi_Regular, sans-serif', color: '#6b6b6b'}}>Connect your Zoho Workplace with other business apps to ensure higher productivity and growth - all within a unified workspace.</p>
          <div className="falt-chips" style={{display: 'flex', flexWrap: 'wrap', gap: '10px'}}>
        ...
        <div className="falt-visual" style={{flex: '1', marginLeft: '20px'}}>
          <img src="/output/generated-assets/zoho-workplace/28-3921942fc4.jpeg" alt="Feature 3" style={{width:'100%',borderRadius:'12px',display:'block'}}/>
        </div>
      </div>
      <div className="falt-block flip" style={{padding: '20px 0', display: 'flex', alignItems: 'center', flexWrap: 'wrap'}}>
        <div className="falt-num" style={{fontSize: '24px', fontWeight: 'bold', marginRight: '20px'}}>04</div>
        <div style={{flex: '1'}}>
          <h3 style={{color: '#1a1a1a', fontFamily: 'Inter', marginBottom: '10px'}}>Performance Beyond Limits with Zoho Workplace</h3>
          <div className="falt-chips" style={{display: 'flex', flexWrap: 'wrap', gap: '10px'}}>
        ...
        <div className="falt-visual" style={{flex: '1', marginLeft: '20px'}}>
          <img src="/output/generated-assets/zoho-workplace/12-cc95c2320b.png" alt="Feature 4" style={{width:'100%',borderRadius:'12px',display:'block'}}/>
        </div>
      </div>
    </div>
  </div>
...
<section className="fig" style={{backgroundColor: '#ffffff', padding: '60px 0'}}>
  <div className="container" style={{position: 'relative'}}>
    <img src="/output/generated-assets/zoho-workplace/27-9026080137.png" alt="Zoho Workplace" style={{width: '100%', height: '100%', objectFit: 'cover', display: 'block', position: 'absolute', inset: 0, borderRadius: '12px', opacity: 0.05}} />
    <div className="fig-head" style={{textAlign: 'center', marginBottom: '40px'}}>
      <div className="eyebrow" style={{fontSize: '14px', letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '10px', color: '#1a1a1a'}}>Key Features</div>
      <h2 style={{fontSize: 'clamp(32px, 5vw, 60px)', fontFamily: 'Inter', color: '#1a1a1a', marginBottom: '20px'}}>Elevate Your Team’s Productivity with Zoho Workplace</h2>
      <p style={{fontFamily: 'Zoho_Puvi_Regular, sans-serif', fontSize: '16px', lineHeight: '1.5', color: '#1a1a1a'}}>A Complete Email & Collaboration Suite for Enterprises that Facilitates Unified Communication.</p>
    </div>
    <div className="fig-grid stagger-parent" style={{display: 'flex', flexWrap: 'wrap', gap: '20px', justifyContent: 'center'}}>
      {[{title: "All-in-One Unified Workspace", description: "Access email, chat, documents, meetings, and storage in a single integrated platform. Reduce app switching and boost pro"}, {title: "Seamless Collaboration in Real Time", description: "Work together on documents, spreadsheets, and presentations with live editing, comments, and built-in communication tool"}, {title: "Work from Anywhere, Anytime", description: "Stay productive on the go. Reply to emails, access presentations, or host a video conference from anywhere effortlessly."}, {title: "AI-Powered Productivity (Zia)", description: "Leverage built-in AI for writing assistance in terms of grammar, readability and writing style while you work on Writer "}, {title: "Ideal For Your Business Size", description: "Designed for any organization, Zoho Workplace enhances efficiency and teamwork at every scale."}, {title: "Communicate Effectively", description: "Go beyond email and chat, and connect teams with a social intranet using channels, feeds, and groups."}].map((feature, index) => (
        <div className="fig-card" style={{flex: '1 1 calc(33% - 40px)', minWidth: '250px', maxWidth: '350px', background: '#ffffff', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)', padding: '20px', textAlign: 'left', transform: 'translateY(20px)', opacity: 0, animation: `fadeInUp 0.3s ease-out forwards`, animationDelay: `${index * 0.15}s`}}>
          <div className="fig-icon" style={{marginBottom: '15px', display: 'flex', justifyContent: 'center', alignItems: 'center', width: '40px', height: '40px', borderRadius: '50%', backgroundColor: 'var(--accent)'}}>
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{width: '16px', height: '16px', fill: '#ffffff'}}>
              <circle cx="12" cy="12" r="12"/>
            </svg>
          </div>
          <h4 style={{fontSize: '18px', fontFamily: 'Zoho_Puvi_Regular, sans-serif', marginBottom: '12px', color: '#1a1a1a'}}>{feature.title}</h4>
          <p style={{fontSize: '14px', fontFamily: 'Zoho_Puvi_Regular, sans-serif', lineHeight: '1.6', color: '#666666'}}>{feature.description}</p>
          {index === 0 && <img src="/output/generated-assets/zoho-workplace/18-473c14de05.jpg" alt="Feature 1" style={{width:'100%', borderRadius:'12px', display:'block', marginTop: '20px'}} />}
          {index === 1 && <img src="/output/generated-assets/zoho-workplace/31-89ce3cb959.jpeg" alt="Feature 2" style={{width:'100%', borderRadius:'12px', display:'block', marginTop: '20px'}} />}
          {index === 2 && <img src="/output/generated-assets/zoho-workplace/28-3921942fc4.jpeg" alt="Feature 3" style={{width:'100%', borderRadius:'12px', display:'block', marginTop: '20px'}} />}
          {index === 3 && <img src="/output/generated-assets/zoho-workplace/12-cc95c2320b.png" alt="Feature 4" style={{width:'100%', borderRadius:'12px', display:'block', marginTop: '20px'}} />}
        </div>
      ))}
    </div>
  </div>
...
<section className="mns" style={{backgroundColor:'#ffffff',padding:'50px 0'}}>
  <div className="mns-head" style={{position:'relative',marginBottom:'30px'}}>
    <img src="/output/generated-assets/zoho-workplace/27-9026080137.png" alt="Zoho Workplace" style={{width:'100%',height:'100%',objectFit:'cover',display:'block',position:'absolute',inset:0,borderRadius:'12px'}}/>
  </div>
  <div className="container" style={{position:'relative',zIndex:2}}>
    <h2 className="mns-label" style={{fontSize:'24px',fontWeight:'600',color:'#1a1a1a',marginBottom:'20px'}}>FEATURES</h2>
    <div className="mns-grid stagger-parent" style={{display:'grid',gap:'20px',gridTemplateColumns:'repeat(auto-fill,minmax(300px,1fr))'}}>
      <div className="mns-card" style={{borderRadius:'12px',overflow:'hidden',boxShadow:'0 2px 8px rgba(0,0,0,0.1)'}}>
        <div style={{padding:'20px',backgroundColor:'#f8fafc'}}>
          <h3 className="mns-pub" style={{fontSize:'18px',fontWeight:'500',color:'#1a1a1a',marginBottom:'10px'}}>TechCrunch</h3>
          <p className="mns-text" style={{fontSize:'16px',color:'#333'}}>“Zoho Workplace: The Complete Suite for Business Productivity”</p>
        </div>
      </div>
      <div className="mns-card" style={{borderRadius:'12px',overflow:'hidden',boxShadow:'0 2px 8px rgba(0,0,0,0.1)'}}>
        <div style={{padding:'20px',backgroundColor:'#f8fafc'}}>
          <h3 className="mns-pub" style={{fontSize:'18px',fontWeight:'500',color:'#1a1a1a',marginBottom:'10px'}}>Forbes</h3>
          <p className="mns-text" style={{fontSize:'16px',color:'#333'}}>“Revolutionize Teamwork with Zoho Workplace”</p>
        </div>
      </div>
      <div className="mns-card" style={{borderRadius:'12px',overflow:'hidden',boxShadow:'0 2px 8px rgba(0,0,0,0.1)'}}>
        <div style={{padding:'20px',backgroundColor:'#f8fafc'}}>
          <h3 className="mns-pub" style={{fontSize:'18px',fontWeight:'500',color:'#1a1a1a',marginBottom:'10px'}}>The Verge</h3>
          <p className="mns-text" style={{fontSize:'16px',color:'#333'}}>“Simplify Business Operations with Zoho Workplace”</p>
        </div>
      </div>
    </div>
  </div>
...
<section className="pdv" style={{background:'#f8fafc',padding:'60px 20px'}}>
  <div className="pdv-head anim d0" style={{textAlign:'center',marginBottom:'40px'}}>
    <p className="eyebrow" style={{color:'#ff6b00',marginBottom:'10px'}}>Product Demo Video</p>
    <h2 style={{fontFamily:'Inter',fontSize:'clamp(32px, 5vw, 60px)',color:'#1a1a1a',marginBottom:'20px'}}>Elevate Your Team’s Productivity with Zoho Workplace</h2>
    <p style={{fontFamily:'Zoho_Puvi_Regular, sans-serif',fontSize:'18px',color:'#333333'}}>A Complete Email & Collaboration Suite for Enterprises that Facilitates Unified Communication.</p>
  </div>
  <div className="pdv-frame" style={{maxWidth:'900px',margin:'0 auto',position:'relative'}}>
    <div className="pdv-browser anim-scale d2" style={{position:'relative',zIndex:1}}>
      <div className="pdv-bar" style={{background:'#ffffff',display:'flex',alignItems:'center',padding:'5px 10px',borderTopLeftRadius:'12px',borderTopRightRadius:'12px',boxShadow:'0 4px 6px rgba(0,0,0,0.1)'}}>
        <div className="pdv-dot" style={{background:'#ff6b00',width:'10px',height:'10px',borderRadius:'50%',marginRight:'5px'}}></div>
        <div className="pdv-dot" style={{background:'#ff6b00',width:'10px',height:'10px',borderRadius:'50%',marginRight:'5px'}}></div>
        <div className="pdv-dot" style={{background:'#ff6b00',width:'10px',height:'10px',borderRadius:'50%'}}></div>
      </div>
      <div style={{position:'relative',borderBottomLeftRadius:'12px',borderBottomRightRadius:'12px',overflow:'hidden'}}>
  ...
  <div className="pdv-cta" style={{textAlign:'center',marginTop:'40px'}}>
    <button className="pdv-btn" style={{background:'#1a1a1a',color:'#ffffff',padding:'10px 20px',borderRadius:'6px',fontSize:'16px',border:'none',cursor:'pointer'}}>Get Started</button>
  </div>
</section>

<section className="wtj" style={{backgroundColor:'#ffffff',padding:'60px 20px'}}>
  <div className="wtj-inner" style={{maxWidth:'1200px',margin:'0 auto',position:'relative'}}>
    <div className="wtj-top" style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:'40px'}}>
      ...
      <div className="wtj-tagline">
        <span style={{fontFamily:'Zoho_Puvi_Regular,sans-serif',fontSize:'1.25rem',color:'#1a1a1a'}}>India's #1 B2B Software Marketplace</span>
      </div>
    </div>
    <div className="wtj-divider" style={{width:'100%',height:'1px',backgroundColor:'#e0e0e0',marginBottom:'40px'}}></div>
    <div className="wtj-grid" style={{display:'flex',flexWrap:'wrap',gap:'20px',justifyContent:'center'}}>
      {[
        ...
        <div key={index} className="wtj-card" style={{flex:'1 1 calc(25% - 20px)',minWidth:'240px',padding:'20px',backgroundColor:'#f8fafc',borderRadius:'12px',boxShadow:'0 4px 6px rgba(0,0,0,0.1)',transition:'transform 0.3s',display:'flex',flexDirection:'column',alignItems:'center'}}>
          <div className="wtj-icon" style={{width:'50px',height:'50px',marginBottom:'20px'}}>
            <svg width="50" height="50" viewBox="0 0 24 24" fill="#ff6b00"><path d="M12 0l3 8h5l-4 6 4 6h-5l-3 8-3-8h-5l4-6-4-6h5z"/></svg>
          </div>
          <h4 style={{fontFamily:'Inter',fontSize:'1.125rem',color:'#1a1a1a',textAlign:'center',marginBottom:'12px'}}>{point.title}</h4>
          <p style={{fontFamily:'Zoho_Puvi_Regular,sans-serif',fontSize:'1rem',color:'#1a1a1a',textAlign:'center'}}>{point.description}</p>
        </div>
      ))}
    </div>
    <div style={{position:'relative',width:'100%',paddingTop:'56.25%',marginTop:'40px',borderRadius:'12px',overflow:'hidden'}}>
      <img src="/output/generated-assets/zoho-workplace/27-9026080137.png" alt="Zoho Workplace" style={{width:'100%',height:'100%',objectFit:'cover',display:'block',position:'absolute',inset:0}}/>
    </div>
  </div>
</section>
...
<section className="plc" style={{background:'#ffffff',padding:'60px 20px'}}>
  <div className="plc-head anim d0" style={{textAlign:'center',marginBottom:'40px'}}>
    <h2 style={{fontSize:'clamp(32px, 5vw, 60px)',fontFamily:'Inter',color:'#1a1a1a',wordBreak:'normal',overflowWrap:'normal',hyphens:'none',margin:'0 0 20px'}}>Elevate Your Team’s Productivity with Zoho Workplace</h2>
    <div style={{position:'relative',width:'100%',height:'450px',borderRadius:'12px',overflow:'hidden',margin:'0 auto'}}>
      <img src="/output/generated-assets/zoho-workplace/27-9026080137.png" alt="Zoho Workplace" style={{width:'100%',height:'100%',objectFit:'cover',display:'block',position:'absolute',inset:0}}/>
    </div>
  </div>
  <div className="plc-grid stagger-parent" style={{display:'flex',flexDirection:'column',alignItems:'center'}}>
    <div className={`plc-card featured`} style={{border:'1px solid #e5e7eb',borderRadius:'12px',padding:'30px',maxWidth:'400px',width:'100%',display:'flex',flexDirection:'column',marginBottom:'40px'}}>
      <div className="plc-badge" style={{textAlign:'center',backgroundColor:'#ff6b00',color:'#ffffff',padding:'5px 10px',borderRadius:'12px',marginBottom:'20px'}}>Best Value</div>
      <div className="plc-plan" style={{fontSize:'24px',fontFamily:'Inter',color:'#1a1a1a',marginBottom:'10px'}}>Zoho Workplace</div>
      <div className="plc-amount" style={{fontSize:'36px',fontFamily:'Inter',color:'#1a1a1a',marginBottom:'10px'}}>$10</div>
      <div className="plc-period" style={{color:'#7b7f86',marginBottom:'20px'}}>per user/month</div>
      <div className="plc-desc" style={{color:'#1a1a1a',fontFamily:'Zoho_Puvi_Regular, sans-serif',marginBottom:'20px'}}>Enterprise-Grade Custom Email</div>
      <ul className="plc-list" style={{color:'#6b7280',marginBottom:'20px',paddingLeft:'20px',listStyle:'disc'}}>
      ...
      <button className="plc-btn primary" style={{background:'#ff6b00',color:'#ffffff',padding:'15px 20px',borderRadius:'8px',border:'none',fontSize:'16px',cursor:'pointer',fontFamily:'Inter'}}>Get Started</button>
    </div>
  </div>
</section>

<section className="tcar" style={{background:'#f8fafc', padding:'40px 0'}}>
  <div className="container" style={{maxWidth:'1200px',margin:'0 auto'}}>
    <header className="tcar-head anim d0" style={{textAlign:'center',marginBottom:'40px'}}>
      <h2 style={{fontFamily:'Inter',fontWeight:700,fontSize:'clamp(32px,5vw,60px)',color:'#1a1a1a'}}>Elevate Your Team’s Productivity with Zoho Workplace</h2>
    ...
    <div className="tcar-layout" style={{display:'flex',alignItems:'center',justifyContent:'space-between'}}>
      <div className="tcar-rail" style={{flex:'1',display:'flex',flexDirection:'column',gap:'20px'}}>
        {testimonials.slice(0, 3).map((t, index) => (
          <div key={index} className="tcar-mini" style={{background:'#ffffff',padding:'20px',borderRadius:'12px',boxShadow:'0 4px 8px rgba(0,0,0,0.05)'}}>
            <div className="tcar-mini-stars" style={{marginBottom:'10px'}}>★★★★★</div>
            <p style={{fontFamily:'Zoho_Puvi_Regular,sans-serif',color:'#1a1a1a',overflow:'hidden',display:'-webkit-box',WebkitBoxOrient:'vertical',WebkitLineClamp:2}}>{t.quote}</p>
          </div>
        ))}
      </div>
      <div className="tcar-stage anim-scale d1" style={{flex:'2',position:'relative'}}>
        {testimonials.map((t, index) => (
          <div key={index} className="tcar-0" style={{padding:'40px',borderRadius:'12px',background:'#ffffff',boxShadow:'0 4px 8px rgba(0,0,0,0.05)',display:'flex',alignItems:'center',gap:'20px',marginBottom:'20px'}}>
            <div className="tcar-avatar" style={{flexShrink:0,width:'60px',height:'60px',borderRadius:'50%',background:'#ccc',display:'flex',alignItems:'center',justifyContent:'center'}}>
              {t.avatar ? <img src={t.avatar} alt={t.author} style={{width:'100%',borderRadius:'50%'}}/> : <span style={{color:'#ffffff',fontWeight:'bold'}}>{t.author.split(' ').map(n => n[0]).join('')}</span>}
            </div>
            <div className="tcar-text">
              <div className="tcar-stars" style={{marginBottom:'10px'}}>★★★★★</div>
              <blockquote className="tcar-quote" style={{fontFamily:'Zoho_Puvi_Regular,sans-serif',color:'#1a1a1a',fontStyle:'italic'}}>{t.quote}</blockquote>
              <div className="tcar-author" style={{marginTop:'10px'}}>
                <span className="tcar-name" style={{fontWeight:'bold'}}>{t.author}</span>, <span className="tcar-role" style={{color:'#666'}}>{t.role}</span>
              </div>
            </div>
          </div>
        ))}
...
<section className="ctadb" style={{ backgroundColor: '#ffffff', padding: '60px 20px', textAlign: 'center', position: 'relative' }}>
  <div className="ctadb-inner" style={{ maxWidth: '800px', margin: '0 auto', position: 'relative', zIndex: 2 }}>
    <h2 className="anim d0" style={{ fontSize: 'clamp(32px, 5vw, 60px)', fontWeight: 'bold', color: '#1a1a1a' }}>
      Elevate Your Team’s Productivity with Zoho Workplace
    </h2>
    <p className="anim d1" style={{ fontSize: '18px', color: '#1a1a1a', marginTop: '20px' }}>
      A Complete Email & Collaboration Suite for Enterprises that Facilitates Unified Communication.
    </p>
    <div className="ctadb-btns anim d2" style={{ marginTop: '40px' }}>
      <a href="#lead-form" className="ctadb-btn" style={{ backgroundColor: '#ff6b00', color: '#ffffff', padding: '10px 20px', borderRadius: '8px', textDecoration: 'none', fontWeight: 'bold', marginRight: '10px' }}>
        Get Started
      </a>
      <a href="#pricing" className="ctadb-ghost" style={{ color: '#1a1a1a', padding: '10px 20px', border: '2px solid #1a1a1a', borderRadius: '8px', textDecoration: 'none', fontWeight: 'bold' }}>
        See Pricing
      </a>
    </div>
  </div>
