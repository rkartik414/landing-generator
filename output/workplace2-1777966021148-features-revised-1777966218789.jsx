...
const LandingPage = () => {
  ...
  const css = `
    ...
    *{box-sizing:border-box} html,body{margin:0;padding:0;background:${bodyBg};scroll-behavior:smooth}
    ...
    .feature-spotlight{display:grid;grid-template-columns:minmax(0,1.02fr) minmax(0,.98fr);gap:24px;align-items:center}
    ...
    .desc-bar{border-left:3px solid ${accent};padding-left:16px;margin:16px 0 22px}
    ...
    .feature-browser{width:100%;max-width:540px;margin:0 auto}
    .feature-browser .browser-frame{border-radius:22px;overflow:hidden}
    .feature-browser .browser-bar{padding:10px 14px}
    .feature-browser img{width:100%;height:360px;display:block;object-fit:cover;object-position:center}
    ...
    .stagger-parent > *{opacity:0;transform:translateY(24px);transition:opacity .55s ease,transform .55s ease}
    ...
    @media (max-width: 1100px){
      ...
      .feature-browser{max-width:100%}
    }
    @media (max-width: 767px){
      .section{padding:56px 0}
      .nav-inner{grid-template-columns:1fr auto}
      .nav-inner .animated-cta{display:none}
      ...
      .feature-spotlight{gap:18px}
      .feature-browser img{height:240px}
      .testi-card,.pricing-card{padding:22px}
    }
  `;
    ...
    <div className="page-wrapper" ref={pageRef}>
      ...
      <nav className="nav">
        <div className="container nav-inner">
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            <span className="brand-logo">ZOHO Workplace</span>
          </div>
          <img
            className="tj-logo"
        ...
        <div className="container hero-grid">
          <div>
            <div className="hero-headline">
              <h1>Boost team collaboration with <span style={{ color: '#fff3e8' }}>Zoho Workplace</span></h1>
            </div>
            <p className="hero-sub">
              Zoho Workplace is a unified suite of communication and productivity apps that helps businesses work smarter with email, chat, meetings, documents, storage, and more in one place.
            </p>
            <div className="hero-chips">
              <span className="chip">{iconSvg} Business Email</span>
              <span className="chip">{iconSvg} Team Chat</span>
              <span className="chip">{iconSvg} Online Office Suite</span>
              <span className="chip">{iconSvg} Video Meetings</span>
            </div>
          ...
          <div className="hero-visual">
            <div className="dashboard-shell reveal-scale visible">
              ...
              <div className="floating-mini float-1">
                ...
                <strong>8+ apps</strong>
              </div>
              <div className="floating-mini float-2">
                <h4>Business email uptime</h4>
      ...
      <section className="section-sm">
        <div className="marquee-wrapper">
          <div className="marquee-track">
            <div className="marquee-item">Mail</div>
            <div className="marquee-item">Cliq</div>
            <div className="marquee-item">Meeting</div>
            <div className="marquee-item">Writer</div>
            <div className="marquee-item">Sheet</div>
            <div className="marquee-item">Show</div>
            <div className="marquee-item">WorkDrive</div>
            <div className="marquee-item">Connect</div>
            <div className="marquee-item">Mail</div>
            <div className="marquee-item">Cliq</div>
            <div className="marquee-item">Meeting</div>
            <div className="marquee-item">Writer</div>
      ...
      <section className="section">
        <div className="container trust-grid">
          <div className="trust-stat reveal-left">
            ...
            <p>Businesses trust Zoho to power secure communication, collaboration, and productivity at scale.</p>
          </div>
        ...
        <div className="container">
          {sections.map((section, index) => (
            <div
              ...
              style={{
                paddingTop: index === 0 ? 0 : 56,
                paddingBottom: index === sections.length - 1 ? 0 : 56,
                borderTop: index === 0 ? 'none' : section.dark ? '1px solid rgba(255,255,255,.08)' : '1px solid #f1f1f1',
                overflow: 'visible'
              }}
            >
              ...
              <div className="feature-spotlight">
                <div className="feature-copy reveal-left">
                  {section.description ? <div className="desc-bar"><p>{section.description}</p></div> : null}
      ...
      <section className="section">
        <div className="container pricing-wrap">
          <div className="section-head reveal" style={{ textAlign: 'center', margin: '0 auto 28px' }}>
            ...
            <p>Get the right Zoho Workplace plan for your business with expert guidance from Techjockey.</p>
          </div>
          ...
          <div className="pricing-card reveal-scale">
            <div className="price-head">
              <div>
                ...
                <p>Business email, collaboration, office apps, meeting tools, and cloud storage in one suite.</p>
              </div>
              <span className="badge-green">Best Value</span>
            </div>

            <div className="price-line">
              <span className="old-price">Starting from</span>
              <span className="new-price">Custom Quote</span>
            </div>

            <div className="checklist stagger-parent">
              <div className="check">{iconSvg}<span>Professional business email</span></div>
              <div className="check">{iconSvg}<span>Integrated chat and meetings</span></div>
              <div className="check">{iconSvg}<span>Cloud office productivity suite</span></div>
              <div className="check">{iconSvg}<span>Shared storage and file management</span></div>
              <div className="check">{iconSvg}<span>Enterprise-grade admin controls</span></div>
              <div className="check">{iconSvg}<span>Support for remote and hybrid teams</span></div>
            </div>
          ...
          <div className="testi-shell reveal-scale">
            ...
            <div className="dots">
              {testimonials.map((_, index) => (
                <button
                  key={index}
                  className={`dot-ind ${activeSlide === index ? 'active' : ''}`}
      ...
      <section className="footer">
        <div className="container footer-grid">
          <div>
            <div className="brand-logo" style={{ marginBottom: 10 }}>ZOHO Workplace</div>
            <p>
              Simplify business communication and collaboration with a unified suite of secure, cloud-based productivity tools.
            </p>
            <div className="socials">
              <a href="https://www.facebook.com/Techjockey/" target="_blank" rel="noreferrer" aria-label="Facebook">f</a>
              <a href="https://www.linkedin.com/company/techjockey/" target="_blank" rel="noreferrer" aria-label="LinkedIn">in</a>
              <a href="https://twitter.com/TechjockeyInfo" target="_blank" rel="noreferrer" aria-label="Twitter">x</a>
            </div>
          </div>

          <div>
            <h3 style={{ color: '#fff', fontSize: 18 }}>Quick Links</h3>
            <p><a href="#features">Features</a></p>
            <p><a href={ctas[2].href} target="_blank" rel="noreferrer">{ctas[2].text}</a></p>
          </div>

          <div>
            <h3 style={{ color: '#fff', fontSize: 18 }}>Get Started</h3>
            <p>Connect with Techjockey to find the right Zoho Workplace plan for your team.</p>
