  ...
  const css = `
    *{box-sizing:border-box}
    ...
    .hero{
      padding:46px 0 72px;
      background:
        radial-gradient(circle at 0% 0%, rgba(242,100,48,.08) 0%, rgba(242,100,48,0) 32%),
    ...
    .hero-cinematic-bg{
      position:absolute;inset:18px 0 18px 18px;
      border-radius:28px;
      background:linear-gradient(180deg, rgba(242,100,48,.08), rgba(255,255,255,.96));
      border:1px solid #f1dfd7;
      box-shadow:0 20px 50px rgba(242,100,48,.08);
    }
    .hero-orb,.hero-orb2{
      position:absolute;border-radius:50%;filter:blur(8px);pointer-events:none;
    }
    .hero-orb{
      width:220px;height:220px;right:-10px;top:-6px;
      background:radial-gradient(circle, rgba(242,100,48,.18) 0%, rgba(242,100,48,0) 70%);
    }
    .hero-orb2{
      width:180px;height:180px;left:0;bottom:18px;
    ...
    .browser-frame img{
      flex:1;min-height:0;height:420px;width:100%;object-fit:contain;object-position:center;
    ...
    .human-png{
      position:absolute;right:18px;bottom:-2px;width:170px;z-index:4;pointer-events:none;
    ...
    @media (max-width: 900px){
      ...
      .split-section,.trust-grid,.feature-shell{grid-template-columns:1fr}
    ...
    @media (max-width: 640px){
      ...
      .hero-overlap-title{width:100%;margin-right:0}
      .hero p.sub{font-size:16px}
      .hero p.support{font-size:15px}
      .browser-frame img{height:300px}
      .float-card.small{right:8px;top:18px}
      .float-card.bottom{left:8px;bottom:18px}
      .human-png{width:120px;right:8px}
    ...
    <div className="lp-root" ref={pageRef}>
        ...
        <div className="container nav-inner">
          <div className="brand-left">
            ...
            <div>
              ...
              <div className="brand-sub">ManageEngine Endpoint Central</div>
            </div>
          </div>
        ...
        <div className="container hero-shell">
          <div className="hero-grid">
            <div className="hero-copy reveal">
              ...
              <h1 className="split-text hero-overlap-title">Secure and manage every endpoint from a single console</h1>
              <p className="sub">
                ManageEngine Endpoint Central helps enterprises automate patching, protect endpoints, control applications,
                and simplify IT operations across distributed environments.
              </p>
              <p className="support">
                Buy with Techjockey and get expert guidance throughout evaluation, purchase, onboarding, and deployment.
              </p>
              ...
              <div className="chips stagger-parent">
                ...
                <div className="chip">Zero-Trust Controls</div>
              </div>
            ...
            <div className="hero-visual reveal reveal-delay-1">
              ...
              <div className="hero-orb float-ambient" />
              ...
              <div className="visual-card zoom-reveal">
                <div className="browser-frame">
                  ...
                  <img
                    src="https://staticimg.techjockey.com/web-assets/images/manageengine/endpoint-central-dashboard.webp"
                    alt="ManageEngine Endpoint Central dashboard"
                  />
                </div>
              </div>
              <div className="float-card small reveal reveal-delay-2">
                <div className="float-title">Operational Control</div>
                <div className="float-value">Single-pane visibility</div>
                <div className="float-line" />
              </div>
              <div className="float-card bottom reveal reveal-delay-3">
                <div className="float-title">Security Posture</div>
                <div className="float-value">Continuous remediation</div>
                <div className="float-line" />
              </div>
              <img
                className="human-png"
      ...
      <section className="section section-light">
        <div className="container trust-grid">
          <div className="trust-copy reveal">
            ...
            <h2>Make your endpoint security investment with confidence</h2>
            <p>
              From discovery to onboarding, Techjockey helps your team choose the right edition, understand deployment
              requirements, and accelerate adoption with product experts.
            </p>
          </div>
          <div className="logo-grid reveal reveal-delay-1">
            {[
              ...
              <div className="logo-item hover-lift" key={idx}>
        ...
        <div className="container split-section">
          <div className="media-panel zoom-reveal reveal">
            <img
              ...
              alt="Endpoint monitoring and security management"
            />
          </div>
          <div className="reveal reveal-delay-1">
            <div className="section-tag">Core Capabilities</div>
            <div className="section-head">
              <h2>Automate patching and secure endpoints at scale</h2>
              <p>
                Endpoint Central combines patch automation, browser protection, data security, and vulnerability
                remediation so your team can reduce risk without increasing manual effort.
              </p>
            </div>
            <div className="desc-rail">
              Consolidate critical endpoint security and management workflows in one platform to improve compliance,
              accelerate remediation, and maintain operational continuity.
            </div>
              ...
              <div className="preview-card hover-lift">
                <div className="preview-icon">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M12 2l7 4v6c0 5-3.5 8.5-7 10-3.5-1.5-7-5-7-10V6l7-4z" stroke={accent} strokeWidth="2" />
                ...
                <div className="mini-metrics">
                  <div className="metric">
                    ...
                    <span>Reduce repetitive patching and monitoring tasks across devices.</span>
                  </div>
                  <div className="metric">
                    <strong>Central visibility</strong>
                    <span>Track security posture, exposure, and update compliance from one view.</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="section section-light" id="benefits">
        <div className="container split-section">
          <div className="reveal">
            ...
            <div className="section-head">
              <h2>Improve security, control assets, and simplify IT operations</h2>
              <p>
                Bring endpoint protection, asset intelligence, privilege control, remote support, and compliance into a
                single operational framework.
              </p>
            </div>
            <div className="desc-rail">
              Endpoint Central is designed to help IT teams strengthen security controls while staying efficient in
              hybrid, remote, and multi-location work environments.
            </div>
            <div className="feature-shell">
              <div className="tabs">
              ...
              <div className="preview-card hover-lift">
                <div className="preview-icon">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M4 6h16M7 12h10M10 18h4" stroke={accent} strokeWidth="2" strokeLinecap="round" />
                  </svg>
                </div>
                ...
                <div className="mini-metrics">
                  <div className="metric">
                    ...
                    <span>Enable remote access and collaboration to resolve endpoint issues quickly.</span>
                  </div>
                  <div className="metric">
                    <strong>Audit readiness</strong>
                    <span>Strengthen governance with reports and controls aligned to compliance needs.</span>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div className="media-panel light zoom-reveal reveal reveal-delay-1">
            <img
              src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&w=1200&q=80"
              alt="Secure endpoint management environment"
            />
          </div>
        </div>
      </section>
      ...
      <section className="section section-soft" id="pricing">
        <div className="container">
          <div className="section-head reveal" style={{ textAlign: 'center', maxWidth: 820, margin: '0 auto 26px' }}>
            <h2>Get expert assistance on pricing and licensing</h2>
            <p>
              Licensing can vary by environment, endpoint count, and deployment needs. Talk to Techjockey experts to
              understand the right plan for your organization.
            </p>
          </div>

          <div className="pricing-wrap reveal reveal-delay-1">
            <div className="pricing-card">
              <div className="pricing-badge">Expert-assisted purchase</div>
              <h3>Customized pricing guidance</h3>
              <p>
                Get support on edition selection, deployment planning, and commercial discussions to ensure the solution
                fits your endpoint management and security goals.
              </p>
              <div className="pricing-empty">
                Share your requirements with Techjockey to receive the most relevant licensing and pricing details.
              </div>
      ...
      <section className="section section-light" id="testimonials">
        <div className="container">
          <div className="section-head reveal" style={{ textAlign: 'center', maxWidth: 860, margin: '0 auto 28px' }}>
            <h2>What customers say about Endpoint Central and Techjockey</h2>
            <p>
              Organizations rely on Endpoint Central for endpoint management and trust Techjockey for a smooth buying and
              ...
              {testimonials.map((item, index) => (
                <div className="testimonial-slide" key={index}>
                  ...
                  <div className="author-row">
                    <div className="avatar">{item.author.split(' ').map((n) => n[0]).join('').slice(0, 2)}</div>
      ...
      <section className="section section-soft">
        <div className="container">
          ...
          >
            <div>
              <div className="pricing-badge" style={{ background: '#fff7ed', borderColor: '#fed7aa', color: '#c2410c' }}>
                Need help evaluating the right fit?
              </div>
              <h3 style={{ margin: 0 }}>Connect with a Techjockey product expert today</h3>
              <p style={{ marginTop: 10 }}>
                Get personalized recommendations, purchase assistance, onboarding guidance, and answers to your endpoint
      ...
      <footer className="footer">
        <div className="container">
          <div className="footer-top">
            <div>
              <div className="footer-brand">
                ...
                <div>
                  <div className="brand-name">Techjockey</div>
                  <div className="brand-sub" style={{ color: 'rgba(255,255,255,.7)' }}>
                    Helping businesses choose the right software
                  </div>
                </div>
              </div>
              <div className="footer-info">
                <span>ManageEngine Endpoint Central</span>
                <span>Expert purchase support</span>
                <span>Demo & onboarding guidance</span>
              </div>
            </div>
            ...
            <div className="socials">
              <a href="https://www.facebook.com/techjockey/" target="_blank" rel="noreferrer" aria-label="Facebook">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M13.5 8H16V5h-2.5C10.46 5 9 6.79 9 9.67V12H7v3h2v4h3v-4h3l.5-3H12V9.9c0-1.02.28-1.9 1.5-1.9z" />
                </svg>
              </a>
              <a href="https://www.linkedin.com/company/techjockey/" target="_blank" rel="noreferrer" aria-label="LinkedIn">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M6.94 8.5A1.56 1.56 0 1 1 6.94 5.4a1.56 1.56 0 0 1 0 3.1zM5.5 9.75H8.4V19H5.5V9.75zm4.68 0h2.78v1.26h.04c.39-.74 1.34-1.52 2.76-1.52 2.96 0 3.5 1.95 3.5 4.49V19h-2.9v-4.37c0-1.04-.02-2.38-1.45-2.38-1.45 0-1.67 1.13-1.67 2.3V19h-2.9V9.75z" />
                </svg>
              </a>
              <a href="https://twitter.com/techjockey" target="_blank" rel="noreferrer" aria-label="Twitter">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M22 5.92c-.74.33-1.53.55-2.36.65a4.1 4.1 0 0 0 1.8-2.27 8.18 8.18 0 0 1-2.6.99 4.08 4.08 0 0 0-6.95 3.72A11.58 11.58 0 0 1 3.5 4.89a4.08 4.08 0 0 0 1.26 5.45 4.04 4.04 0 0 1-1.85-.51v.05a4.08 4.08 0 0 0 3.27 4 4.1 4.1 0 0 1-1.84.07 4.09 4.09 0 0 0 3.81 2.84A8.2 8.2 0 0 1 2 18.58a11.56 11.56 0 0 0 6.26 1.83c7.5 0 11.6-6.21 11.6-11.6 0-.18 0-.35-.01-.53A8.3 8.3 0 0 0 22 5.92z" />
                </svg>
              </a>
          ...
          <div className="footer-bottom">
            <div>© 2024 Techjockey. All rights reserved.</div>
            <div className="footer-links">
              <a href="https://www.techjockey.com/privacy-policy" target="_blank" rel="noreferrer">
                Privacy Policy
              </a>
              <a href="https://www.techjockey.com/terms-and-conditions" target="_blank" rel="noreferrer">
                Terms & Conditions
              </a>
