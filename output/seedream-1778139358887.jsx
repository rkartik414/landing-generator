...
@keyframes fadeUp { from { opacity:0; transform:translateY(28px); } to { opacity:1; transform:translateY(0); } }
  ...
  <video autoPlay loop muted playsInline className="hvf-video">
    <source src="/output/generated-assets/ds_1778139129389_c1a69ed2/08-8c93b9a6e6.mp4" type="video/mp4" />
  </video>
  <div className="hvf-overlay"></div>
  <div className="hvf-content">
    <div className="hvf-inner">
      <h1 className="hvf-h1 anim d0">
        Create High-Quality AI Images & Videos with ByteDance Generative Models using <span className="hvf-accent">Seedream 4.5 and Seedance 1.5 Pro by ByteDance</span>
      </h1>
      ...
      <div className="hvf-proof">
        <div className="hvf-avatars">
          <span className="hvf-av" style={{ backgroundColor: '#FFA000' }}>A</span>
          <span className="hvf-av" style={{ backgroundColor: '#FF4081' }}>B</span>
          <span className="hvf-av" style={{ backgroundColor: '#9C27B0' }}>C</span>
          <span className="hvf-av" style={{ backgroundColor: '#2196F3' }}>D</span>
        </div>
        <div className="hvf-stars">
          <svg className="hvf-star" width="20" height="20" fill="#FFD700" /> {/* Star SVG repeated 5 times */}
          <svg className="hvf-star" width="20" height="20" fill="#FFD700" />
          <svg className="hvf-star" width="20" height="20" fill="#FFD700" />
          <svg className="hvf-star" width="20" height="20" fill="#FFD700" />
          <svg className="hvf-star" width="20" height="20" fill="#FFD700" />
        </div>
      ...
      <div className="anim d2">
        <input type="text" placeholder="Enter your email" className="hvf-input" />
...
<section className="tms">
  <div className="tms-grid">
    <div className="tms-cell reveal d0">
    ...
    <div className="tms-cell reveal d1">
    ...
    <div className="tms-cell reveal d2">
...
<section className="falt">
  <div className="container reveal anim d0">
    <div className="text-center falt-head">
      <div className="eyebrow">section_label</div>
      <h2 className="h2">Create High-Quality AI Images & Videos with ByteDance Generative Models</h2>
    </div>
    {[{"num":"01","title":"AI Image Generation with Seedream 4.5","description":"Seedream 4.5 is a high-performance multimodal image generation system designed to produce high-resolution, high-fidelity images from text prompts and visual inputs. The model unifies text-to-image synthesis, image editing, and multi-image composition within a single framework.","features":["Advanced Text–Image Alignment","High-Resolution Output","Superior Typographic Rendering","Multi-Image Composition with Identity Preservation","Strong Structural Fidelity","Advanced Capabilities of Seedream 4.5 by ByteDance"],"image_url":"/output/generated-assets/ds_1778139129389_c1a69ed2/15-41ea7f7485.png","video_url":""},{"num":"02","title":"AI Video Generation with Seedance 1.5 Pro by Bytedance","description":"Seedance 1.5 Pro is a next-generation generative model designed for native audio-visual generation, enabling synchronized creation of video and sound together. Built on a dual-branch diffusion transformer architecture, the model integrates cross-modal learning to produce coherent visual and audio outputs.","features":["Key Capabilities of Seedance 1.5 Pro","Text-to-Video Generation","Audio-Visual Synchronization","Multilingual Lip-Sync","Cinematic Camera Control","10× Faster Inference"],"image_url":"/output/generated-assets/ds_1778139129389_c1a69ed2/12-581339b7d2.png","video_url":""}]
      .map((section, index) => (
          ...
          <div className="falt-copy">
            ...
            <div className="falt-chips">
              {section.features.map(feature => (
                <div className="falt-chip" key={feature}>{feature}</div>
              ))}
            </div>
          </div>
          {section.video_url ? (
            <div className="falt-visual">
              <video src={section.video_url} className="w-full h-auto" controls></video>
            </div>
          ) : (
            <div className="falt-visual">
              <img src={section.image_url} alt={section.title} className="w-full h-auto" />
            </div>
          )}
        </div>
      ))
...
<section className="fig py-24 bg-white">
  <div className="max-w-6xl mx-auto px-6">
    <div className="fig-head text-center mb-16">
      <div className="eyebrow inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-bold tracking-wider uppercase bg-[#b3713f]/10 border border-[#b3713f]/25 text-[#b3713f]">section_label</div>
      <h2 className="text-4xl font-bold tracking-tight leading-tight mb-4">Create High-Quality AI Images & Videos with ByteDance Generative Models</h2>
      <p className="text-lg leading-relaxed text-gray-500">Unlock the power of next-generation generative AI with Seedream 4.5 (Image Generation) and Seedance 1.5 Pro (Video Generation) - advanced foundation models developed by ByteDance for high-quality visual content creation.</p>
    </div>
    <div className="fig-grid grid gap-10 md:grid-cols-2 reveal stagger-parent">
      <div className="fig-card rounded-2xl border border-gray-100 bg-white p-7 shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300 anim d0">
        <h4 className="text-lg font-bold mb-3">Advanced Text–Image Alignment</h4>
        <p className="text-sm leading-normal text-gray-500">Accurately translates prompts into visuals with improved semantic understanding.</p>
      </div>
      <div className="fig-card rounded-2xl border border-gray-100 bg-white p-7 shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300 anim d1">
        <h4 className="text-lg font-bold mb-3">High-Resolution Output</h4>
        <p className="text-sm leading-normal text-gray-500">Generate native images up to 1K–4K resolution with strong visual fidelity.</p>
      </div>
      <div className="fig-card rounded-2xl border border-gray-100 bg-white p-7 shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300 anim d2">
        <h4 className="text-lg font-bold mb-3">Superior Typographic Rendering</h4>
        <p className="text-sm leading-normal text-gray-500">Optimized for posters, ads, and text-heavy visual designs.</p>
      </div>
      <div className="fig-card rounded-2xl border border-gray-100 bg-white p-7 shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300 anim d3">
        <h4 className="text-lg font-bold mb-3">Multi-Image Composition with Identity Preservation</h4>
        <p className="text-sm leading-normal text-gray-500">Combines multiple inputs while accurately maintaining subject consistency.</p>
      </div>
      <div className="fig-card rounded-2xl border border-gray-100 bg-white p-7 shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300 anim d4">
        <h4 className="text-lg font-bold mb-3">Strong Structural Fidelity</h4>
        <p className="text-sm leading-normal text-gray-500">Maintains composition, layout, and scene structure with high precision.</p>
      </div>
      <div className="fig-card rounded-2xl border border-gray-100 bg-white p-7 shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300 anim d5">
        <h4 className="text-lg font-bold mb-3">Advanced Capabilities of Seedream 4.5 by ByteDance</h4>
        <p className="text-sm leading-normal text-gray-500">From accurate text rendering to consistent image editing and multi-image composition, Seedream 4.5 powers high-quality, professional visual creation with superior precision and control.</p>
      </div>
    </div>
  </div>
</section>
...
<section className="gvw py-24 bg-white">
  <div className="max-w-6xl mx-auto px-6">
    ...
    <p className="text-lg leading-relaxed text-gray-500">Unlock the power of next-generation generative AI with Seedream 4.5 (Image Generation) and Seedance 1.5 Pro (Video Generation) - advanced foundation models developed by ByteDance for high-quality visual content creation.</p>
    <div className="gvw-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
      {[
        ...
        <div key={index} className="gvw-card anim-scale">
          ...
          <span className="gvw-caption block text-center mt-2 font-bold text-[#b3713f]">{video.caption}</span>
        </div>
      ))}
    </div>
  </div>
...
<section className="wtj py-24 bg-white">
  <div className="wtj-inner max-w-6xl mx-auto px-6">
    <div className="wtj-top flex flex-col items-center text-center">
      ...
      <p className="wtj-tagline text-4xl font-bold tracking-tight leading-tight text-[#b3713f]">India's #1 B2B Software Marketplace</p>
      <div className="wtj-divider my-8 w-16 h-1 bg-[#b3713f]"></div>
    </div>
    <div className="wtj-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-10">
      {[
        {
        ...
        <div key={idx} className="wtj-card reveal transition-transform duration-300 ease-out">
          <div className="flex items-center">
            <svg className="wtj-icon w-6 h-6 text-[#b3713f] mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
...
<section className="pdc py-24">
  <div className="container">
    <div className="pdc-head anim d0">
      <div className="eyebrow inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-bold tracking-wider uppercase bg-[#b3713f]/10 text-[#b3713f]">
        New Release
      </div>
    ...
    <div className="pdc-grid grid gap-8 mt-12 grid-cols-1 lg:grid-cols-2">
      <div className="pdc-card featured rounded-2xl border border-gray-100 bg-white p-7 shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300 anim d1">
        <h3 className="pdc-plan text-2xl font-semibold text-gray-900 mb-4">Seedream 4.5 (AI Image Generation)</h3>
        <p className="pdc-price">
          <span className="pdc-amount text-3xl font-bold text-gray-900">Contact for Pricing</span>
        </p>
        <span className="pdc-badge pdc-badge inline-flex items-center gap-1.5 rounded-full bg-[#b3713f]/10 border border-[#b3713f]/25 text-[#b3713f] px-3 py-1 text-xs font-bold tracking-wider uppercase">Discount Available</span>
        <p className="pdc-period text-sm font-medium text-gray-500 mt-2">per user/month</p>
        <ul className="pdc-list mt-6 space-y-2">
          <li className="flex items-center text-sm font-medium text-gray-800">
            <svg className="w-4 h-4 text-[#b3713f] mr-2 pdc-check" fill="currentColor" viewBox="0 0 20 20"><path d="M16.707 5.293a1 1 0 00-1.414-1.414L9 10.586 5.707 7.293A1 1 0 104.293 8.707l4 4a1 1 0 001.414 0l7-7z" /></svg>
        ...
        <button className="pdc-btn inline-flex items-center justify-center mt-6 rounded-xl text-sm font-semibold h-11 px-6 bg-[#b3713f] text-white shadow hover:opacity-90 transition-all focus-visible:outline-none">Contact Sales</button>
      </div>
      <div className="pdc-card rounded-2xl border border-gray-100 bg-white p-7 shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300 anim d2">
        <h3 className="pdc-plan text-2xl font-semibold text-gray-900 mb-4">Seedance 1.5 Pro (AI Video Generation)</h3>
        <p className="pdc-price">
          <span className="pdc-amount text-3xl font-bold text-gray-900">Starting at $1,000/month/</span>
        </p>
        <p className="pdc-period text-sm font-medium text-gray-500 mt-2">per user/month</p>
        <ul className="pdc-list mt-6 space-y-2">
          <li className="flex items-center text-sm font-medium text-gray-800">
        ...
        <button className="pdc-btn inline-flex items-center justify-center mt-6 rounded-xl text-sm font-semibold h-11 px-6 bg-[#b3713f] text-white shadow hover:opacity-90 transition-all focus-visible:outline-none">Learn More</button>
      </div>
    </div>
  </div>
</section>
...
const testimonials = [
  {
    ...
    avatar: "/output/generated-assets/ds_1778139129389_c1a69ed2/06-0518458b81.webp",
  },
  {
...
<section className="tcar">
  <div className="max-w-6xl mx-auto px-6">
    <div className="anim d0 tcar-head">
      <span className="eyebrow">Section</span>
      <h1 className="text-5xl lg:text-6xl font-bold tracking-tight leading-tight text-[#111827]">Create High-Quality AI Images & Videos with ByteDance Generative Models</h1>
      <p className="text-lg leading-relaxed text-[#4b5563]">Unlock the power of next-generation generative AI with Seedream 4.5 (Image Generation) and Seedance 1.5 Pro (Video Generation) - advanced foundation models developed by ByteDance for high-quality visual content creation.</p>
    </div>
    <div className="tcar-rail mt-8">
      {testimonials.slice(0, 3).map(({ quote, author }, index) => (
        <div key={index} className="tcar-mini">
          <div className="tcar-mini-stars">★★★★★</div>
          <p className="tcar-text">{quote.length > 100 ? `${quote.slice(0, 100)}...` : quote}</p>
          <div className="tcar-mini-author"> {author} </div>
        </div>
      ))}
    </div>
      ...
      <div className="tcar-track" style={{ transform: `translateX(${-slide * 100}%)` }}>
        {testimonials.map(({ quote, author, role, avatar }, index) => (
          <div key={index} className="tcar-slide">
            <div className="tcar-quote">“{quote}”</div>
            <div className="tcar-stars">★★★★★</div>
            <div className="tcar-author flex items-center mt-4">
              {avatar ? (
                <img src={avatar} alt={author} className="tcar-avatar w-12 h-12 rounded-full" />
              ) : (
                <div className={`tcar-avatar w-12 h-12 rounded-full bg-gray-300 flex items-center justify-center text-white`}>
                  {author.split(' ').map(name => name[0]).join('')}
                </div>
              )}
              <div className="tcar-name text-[#111827] font-semibold ml-4">
                {author}
                <div className="tcar-role text-sm text-gray-500">{role}</div>
              </div>
            </div>
          </div>
        ))}
    ...
    <div className="tcar-dots flex justify-center mt-4">
      {testimonials.map((_, index) => (
        <button
          ...
          className={`tcar-dot ${index === slide ? 'opacity-100' : 'opacity-50'}`}
        />
      ))}
    </div>
  </div>
...
<section className="ctavb">
  ...
  <div className="ctavb-inner">
    <h2 className="h2 anim d0">Create High-Quality AI Images & Videos with ByteDance Generative Models</h2>
    <p className="body-text anim d1">
      Unlock the power of next-generation generative AI with Seedream 4.5 (Image Generation) and Seedance 1.5 Pro (Video Generation) - advanced foundation models developed by ByteDance for high-quality visual content creation.
    </p>
    <a href="#lead-form" className="ctavb-btn anim d2 bg-[#b3713f] text-white hover:opacity-90 transition-all">
      Generate with AI
    </a>
  </div>
</section>
