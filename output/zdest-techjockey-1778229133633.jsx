    ...
    <div>
     ...
     <nav className="sticky top-0 z-50 bg-gray-900/90 backdrop-blur-xl border-b border-white/10 py-3.5">
        <div className="max-w-6xl mx-auto px-6 flex justify-between items-center gap-4">
          <span className="font-extrabold text-xl text-[#ff6c53]">Zoho Desk</span>
          <img src="https://cdn.techjockey.com/web/assets/V5/img/logo.svg" height="28" alt="Techjockey" className="h-7 opacity-95" />
          <a href="#lead-form" className="inline-flex items-center justify-center rounded-xl text-sm font-semibold h-11 px-6 bg-[#ff6c53] text-white shadow hover:-translate-y-0.5 hover:opacity-90 transition-all focus-visible:outline-none disabled:opacity-50 text-sm" style={{textDecoration:'none'}}>Get Free Consultation</a>
        </div>
      </nav>

      <section className="relative h-screen bg-[#f8fafc] flex items-center justify-center overflow-hidden">

  {/* BG — full cover */}
  <div className="absolute inset-0">
    <img src="/output/generated-assets/ds_1778228999760_93fb8902/12-bd4c399912.jpeg" alt="Zoho Desk" style={{width:'100%',height:'100%',objectFit:'cover',display:'block',position:'absolute',inset:0}}/>
  </div>

  {/* Gradient overlay */}
  <div className="absolute inset-0 bg-gradient-to-r from-[#f8fafc] via-transparent to-transparent"></div>

  {/* Content — left with flex column */}
  <div className="relative z-10 max-w-6xl mx-auto flex flex-col items-start space-y-4 px-6">
    <span className="inline-flex items-center gap-1.5 rounded-full bg-[#ff6c53]/10 border border-[#ff6c53]/25 text-[#ff6c53] px-3 py-1 text-xs font-bold tracking-wider uppercase">
      Why Choose Zoho Desk?
    </span>
    <h1 className="text-5xl lg:text-6xl font-bold tracking-tight leading-[1.05] text-[#ff6c53]">
    ...
    <a href="#" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center rounded-xl text-sm font-semibold h-11 px-6 bg-[#ff6c53] text-white shadow hover:-translate-y-0.5 hover:opacity-90 transition-all focus-visible:outline-none disabled:opacity-50">
      Get Your Free Trial
    </a>
  </div>

  {/* Product panel — bottom right */}
  <div className="absolute bottom-12 right-12 w-[300px] h-[200px] rounded-lg overflow-hidden shadow-lg">
...
<section className="tlg py-24 bg-[#f8fafc]">
  <div className="max-w-6xl mx-auto px-6">
    <div className="text-center mb-10">
      <span className="tlg-label inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-bold tracking-wider uppercase bg-[#ff6c53]/10 text-[#ff6c53] border border-[#ff6c53]/25">
        Trusted by 100,000+ Businesses Globally
      </span>
    </div>
    <div className="tlg-logos grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4 justify-items-center">
      <img className="tlg-logo" src="/output/generated-assets/ds_1778228999760_93fb8902/04-0a90587985.svg" alt="Partner 1" />
      <img className="tlg-logo" src="/output/generated-assets/ds_1778228999760_93fb8902/02-6713903685.png" alt="Partner 2" />
      <img className="tlg-logo" src="/output/generated-assets/ds_1778228999760_93fb8902/03-5dd9b65c19.svg" alt="Partner 3" />
      <img className="tlg-logo" src="/output/generated-assets/ds_1778228999760_93fb8902/05-2b26697695.svg" alt="Partner 4" />
      <img className="tlg-logo" src="/output/generated-assets/ds_1778228999760_93fb8902/09-8841e6d25c.svg" alt="Partner 5" />
      <img className="tlg-logo" src="/output/generated-assets/ds_1778228999760_93fb8902/07-e77c692795.svg" alt="Partner 6" />
      <img className="tlg-logo" src="/output/generated-assets/ds_1778228999760_93fb8902/06-ee5f78318d.svg" alt="Partner 7" />
      <img className="tlg-logo" src="/output/generated-assets/ds_1778228999760_93fb8902/08-fc44aea2a2.svg" alt="Partner 8" />
    </div>
  </div>
</section>

<section className="falt py-24 bg-white">
  <div className="max-w-6xl mx-auto px-6">
    <div className="falt-head mb-16 text-center anim d0">
      <span className="eyebrow inline-flex items-center gap-1.5 rounded-full bg-[#ff6c53]/10 border border-[#ff6c53]/25 text-[#ff6c53] px-3 py-1 text-xs font-bold tracking-wider uppercase">Product</span>
      ...
      {[
        {
          ...
          image_url: "/output/generated-assets/ds_1778228999760_93fb8902/18-7f64cfae87.jpeg"
        },
        {
          num: "02",
          ...
          image_url: "/output/generated-assets/ds_1778228999760_93fb8902/17-3965757185.jpeg"
        },
        {
          num: "03",
          ...
          image_url: "/output/generated-assets/ds_1778228999760_93fb8902/19-b36bdf959c.jpeg"
        },
        {
          num: "04",
          title: "Customisation Beyond Limits",
          ...
          image_url: "/output/generated-assets/ds_1778228999760_93fb8902/21-5411ff2828.png"
        }
      ].map((section, index) => (
        <div key={section.num} className={`falt-block ${index % 2 === 0 ? '' : 'flip'} reveal`}>
          <div className="flex flex-col lg:flex-row items-center lg:gap-12">
            <div className="flex-1 lg:order-2">
              <div className="falt-num text-[#ff6c53] mb-4 text-3xl font-bold">
                {section.num}
              </div>
              ...
              <div className="falt-chips flex flex-wrap gap-3">
                {section.features.map((feature, i) => (
                  <div key={i} className="falt-chip inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-bold tracking-wider text-[#ff6c53] bg-[#ff6c53]/10 border border-[#ff6c53]/25">
                    {feature}
                  </div>
                ))}
              </div>
            </div>
            <div className="falt-visual flex-1 relative lg:order-1">
...
<section className="fig py-24 bg-[#f8fafc]">
  <div className="container">
    <div className="fig-head text-center mb-12">
      <span className="eyebrow inline-flex items-center gap-1.5 rounded-full bg-[#ff6c53]/10 border border-[#ff6c53]/25 text-[#ff6c53] px-3 py-1 text-xs font-bold tracking-wider uppercase">section_label</span>
      ...
      {[
        {
          ...
          panel: <img src="/output/generated-assets/ds_1778228999760_93fb8902/18-7f64cfae87.jpeg" alt="Feature 1" style={{ width: '100%', borderRadius: '12px', display: 'block' }} />,
        },
        {
          title: "Ticket Management",
          description: "Organize, prioritize, and resolve tickets efficiently with automation and smart workflows.",
          panel: <img src="/output/generated-assets/ds_1778228999760_93fb8902/17-3965757185.jpeg" alt="Feature 2" style={{ width: '100%', borderRadius: '12px', display: 'block' }} />,
        },
        {
          ...
          panel: <img src="/output/generated-assets/ds_1778228999760_93fb8902/19-b36bdf959c.jpeg" alt="Feature 3" style={{ width: '100%', borderRadius: '12px', display: 'block' }} />,
        },
        {
          title: "Workflow Automation",
          description: "Automate repetitive support tasks, assign tickets, and streamline processes for faster resolutions.",
          panel: <img src="/output/generated-assets/ds_1778228999760_93fb8902/21-5411ff2828.png" alt="Feature 4" style={{ width: '100%', borderRadius: '12px', display: 'block' }} />,
        },
        {
        ...
        <div key={index} className="fig-card rounded-2xl border border-gray-100 bg-white p-7 shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300 reveal">
          <div className="fig-icon mb-4">{feature.panel}</div>
          <h4 className="inline text-lg font-bold">{feature.title}</h4>
          <p className="inline text-md text-gray-600">{feature.description}</p>
        </div>
      ))}
    </div>
  </div>
...
<section className="mns" style={{backgroundColor: '#ffffff', padding: '48px 0'}}>
  <div className="container mx-auto px-6">
    <div className="mns-head">
      <span className="mns-label">FEATURES</span>
    </div>
    <div className="mns-grid grid gap-6 mt-8">
      <div className="mns-card rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition-transform hover:-translate-y-1 hover:shadow-md">
        <img src="/output/generated-assets/ds_1778228999760_93fb8902/18-7f64cfae87.jpeg" alt="Feature 1" style={{width:'100%',borderRadius:'12px',display:'block'}}/>
        <p className="mns-pub text-xs font-bold text-gray-500 mt-4">Omnichannel Support</p>
        <p className="mns-text mt-2 text-gray-800">"Manage customer conversations across email, chat, phone, and social media from a single platform."</p>
      </div>
      <div className="mns-card rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition-transform hover:-translate-y-1 hover:shadow-md">
        <img src="/output/generated-assets/ds_1778228999760_93fb8902/17-3965757185.jpeg" alt="Feature 2" style={{width:'100%',borderRadius:'12px',display:'block'}}/>
        <p className="mns-pub text-xs font-bold text-gray-500 mt-4">Ticket Management</p>
        <p className="mns-text mt-2 text-gray-800">"Organize, prioritize, and resolve tickets efficiently with automation and smart workflows."</p>
      </div>
      <div className="mns-card rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition-transform hover:-translate-y-1 hover:shadow-md">
        <img src="/output/generated-assets/ds_1778228999760_93fb8902/19-b36bdf959c.jpeg" alt="Feature 3" style={{width:'100%',borderRadius:'12px',display:'block'}}/>
        <p className="mns-pub text-xs font-bold text-gray-500 mt-4">AI Assistance (Zia)</p>
        <p className="mns-text mt-2 text-gray-800">"Get intelligent suggestions, auto-tag tickets, detect sentiment, and respond faster with AI-powered insights."</p>
      </div>
    </div>
  </div>
</section>

<section className="pdv py-24 bg-gray-50">
  <div className="max-w-6xl mx-auto px-6">
    <div className="pdv-head text-center mb-12 anim d0">
      <span className="eyebrow inline-flex items-center gap-1.5 rounded-full bg-[#ff6c53]/10 border border-[#ff6c53]/25 text-[#ff6c53] px-3 py-1 text-xs font-bold tracking-wider uppercase">Product Demo</span>
      <h2 className="text-4xl font-bold tracking-tight leading-tight mt-4">Deliver Exceptional Customer Support with Zoho Desk</h2>
      <p className="text-lg leading-relaxed text-gray-500 mt-4">Streamline customer service, manage tickets efficiently, and deliver seamless support experiences across every channel.</p>
    </div>
    <div className="pdv-frame mx-auto anim-scale d2">
      <div className="pdv-browser">
        <div className="pdv-bar flex items-center space-x-1.5 p-2">
          <div className="pdv-dot w-3 h-3 bg-red-400 rounded-full"></div>
          <div className="pdv-dot w-3 h-3 bg-yellow-400 rounded-full"></div>
          <div className="pdv-dot w-3 h-3 bg-green-400 rounded-full"></div>
        </div>
        <div className="relative">
          <video className="pdv-video w-full rounded-b-xl" autoPlay muted loop playsInline>
            <source src="https://www.zohowebstatic.com/sites/zweb/images/desk/zd-hp-banner-video.mp4" type="video/mp4" />
          </video>
          <img src="/output/generated-assets/ds_1778228999760_93fb8902/12-bd4c399912.jpeg" alt="Zoho Desk" style={{width:'100%',height:'100%',objectFit:'cover',display:'block',position:'absolute',inset:0}} />
        </div>
    ...
    <div className="pdv-cta text-center mt-12">
      <button className="pdv-btn inline-flex items-center justify-center rounded-xl text-sm font-semibold h-11 px-6 bg-[#ff6c53] text-white shadow hover:-translate-y-0.5 hover:opacity-90 transition-all">Get Your Free Trial</button>
    </div>
  </div>
</section>
...
<section className="wtj py-24 bg-[#f8fafc]">
  <div className="wtj-inner max-w-6xl mx-auto px-6">
    <div className="wtj-top text-center mb-12">
      <div className="wtj-logo inline-block mb-4">
        <img src="https://beta.techjockey.com/c/kaspersky-office-security/assets/img/tj_logo.svg" alt="Techjockey" className="wtj-logo"/>
      </div>
      <p className="wtj-tagline text-lg leading-relaxed text-gray-500">
        India's #1 B2B Software Marketplace
      </p>
    </div>
    <img src="/output/generated-assets/ds_1778228999760_93fb8902/12-bd4c399912.jpeg" alt="Zoho Desk" style={{width:'100%',height:'100%',objectFit:'cover',display:'block',position:'absolute',inset:0}}/>
    <hr className="wtj-divider my-12 border-t border-gray-200"/>
    <div className="wtj-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div className="wtj-card p-7 bg-white shadow-sm border border-gray-100 rounded-2xl hover:-translate-y-1 hover:shadow-md transition duration-300">
        <svg className="wtj-icon w-6 h-6 text-[#ff6c53] mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 22c1.657 0 3-.895 3-2v0c0-.982-.405-1.817-1.046-2.404C12.768 16.954 11 15.5 11 13V5h2m0 0l4 4m-4-4L9 9"/></svg>
        <h4 className="text-xl font-semibold mb-2">Free Expert Consultation</h4>
        <p className="text-gray-500">Get matched with right software.</p>
      </div>
      <div className="wtj-card p-7 bg-white shadow-sm border border-gray-100 rounded-2xl hover:-translate-y-1 hover:shadow-md transition duration-300">
        <svg className="wtj-icon w-6 h-6 text-[#ff6c53] mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 8h10M7 12h10m-5 8a9 9 0 110-18 9 9 0 010 18z"/></svg>
        <h4 className="text-xl font-semibold mb-2">Verified Reviews</h4>
        <p className="text-gray-500">1000+ genuine customer reviews.</p>
      </div>
      <div className="wtj-card p-7 bg-white shadow-sm border border-gray-100 rounded-2xl hover:-translate-y-1 hover:shadow-md transition duration-300">
        <svg className="wtj-icon w-6 h-6 text-[#ff6c53] mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c3.135 0 6.1 1.32 6.97 3.28C19.536 14.324 16.522 16 12 16s-7.536-1.676-7.97-4.72C5.9 9.32 8.865 8 12 8z"/></svg>
        <h4 className="text-xl font-semibold mb-2">Best Price Guarantee</h4>
        <p className="text-gray-500">Competitive pricing assured.</p>
      </div>
      <div className="wtj-card p-7 bg-white shadow-sm border border-gray-100 rounded-2xl hover:-translate-y-1 hover:shadow-md transition duration-300">
        <svg className="wtj-icon w-6 h-6 text-[#ff6c53] mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12V7l-3 3m-6 2v7m2 2a8 8 0 108 0"/></svg>
...
<section className="plc py-24 bg-white">
  <div className="max-w-6xl mx-auto px-6">
    <div className="plc-head text-center mb-12">
      <span className="eyebrow inline-flex items-center gap-1.5 rounded-full bg-[#ff6c53]/10 border border-[#ff6c53]/25 text-[#ff6c53] px-3 py-1 text-xs font-bold tracking-wider uppercase">Plans</span>
    ...
    <div className="plc-grid grid grid-cols-1 md:grid-cols-3 gap-6 reveal">
      <div className={`plc-card featured rounded-2xl border border-gray-200 bg-white shadow-sm p-7 transition-all duration-300 hover:-translate-y-1 hover:shadow-md`}>
        <div className="plc-badge">Most Popular</div>
        <h3 className="plc-plan font-semibold text-xl mb-2">Zoho Desk</h3>
        <p className="plc-amount text-3xl font-bold text-[#ff6c53]">$15</p>
        <span className="plc-old text-sm line-through text-gray-400">$19</span>
        <span className="plc-period text-sm text-gray-500 ml-2">per user/month</span>
        <p className="plc-desc text-lg leading-relaxed text-gray-500 mt-4 mb-6">Empower your support team with cutting-edge tools to streamline operations and enhance customer satisfaction.</p>
        <ul className="plc-list text-sm text-gray-700 mb-8">
          {["Ticket Management", "Omnichannel Support", "Workflow Automation", "AI-Powered Assistance", "Knowledge Base", "Reporting & Analytics", "Integrations", "Alerts & Notifications", "Supported Device: Android, iOS, Windows, Mac"].map((feature, index) => (
            <li key={index} className="flex items-center mb-2"><span className="inline-flex items-center justify-center w-4 h-4 mr-2 bg-[#ff6c53] text-white rounded-full">✓</span>{feature}</li>
          ))}
        </ul>
        <button className="plc-btn primary inline-flex items-center justify-center rounded-xl text-sm font-semibold h-11 px-6 bg-[#ff6c53] text-white shadow hover:-translate-y-0.5 hover:opacity-90 transition-all focus-visible:outline-none disabled:opacity-50">Get Your Free Trial</button>
      </div>
    </div>
  </div>
</section>
...
const TestimonialsCarousel = () => {
  ...
  return (
    <section className="tcar py-24 bg-[#ffffff]">
      <div className="max-w-6xl mx-auto px-6">
        <div className="tcar-head mb-12 text-center">
          <span className="eyebrow">Testimonials</span>
          <h2 className="text-4xl font-bold tracking-tight leading-tight mt-4">Deliver Exceptional Customer Support with Zoho Desk</h2>
          <p className="text-lg leading-relaxed text-gray-500 mt-4">Streamline customer service, manage tickets efficiently, and deliver seamless support experiences across every channel.</p>
        </div>
        <div className="tcar-layout flex flex-col-reverse lg:flex-row gap-8">
          <div className="tcar-rail flex flex-col gap-4 lg:w-1/3">
            {testimonials.slice(0, 3).map((test, index) => (
              <div key={index} className="tcar-mini p-4 border border-gray-200 rounded-lg">
                <p className="tcar-mini-stars mb-2">★★★★★</p>
                <p className="line-clamp-2">{test.quote}</p>
              </div>
            ))}
          </div>
          <div className="tcar-stage relative flex-1 overflow-hidden">
            <div className={`tcar-track transition-transform duration-500 transform -translate-x-[${slide * 100}%]`}>
              {testimonials.map((test, index) => (
                <div key={index} className="tcar-slide shrink-0 w-full px-6">
                  <div className="tcar-quote p-6 shadow bg-white rounded-xl">
                    <p className="tcar-stars text-yellow-500">★★★★★</p>
                    <p className="tcar-text mt-4 mb-6">{test.quote}</p>
                    <div className="tcar-author flex items-center gap-4">
                      <div className={`tcar-avatar w-12 h-12 rounded-full bg-${index % 2 === 0 ? 'blue' : 'green'}-300 flex items-center justify-center text-white font-bold`}>
                        {test.author.split(' ').map(name => name[0]).join('')}
                      </div>
                      <div>
                        <p className="tcar-name font-semibold">{test.author}</p>
                        <p className="tcar-role text-gray-500">{test.role} {test.company ? `at ${test.company}` : ""}</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="tcar-dots mt-8 flex justify-center">
          {testimonials.map((_, index) => (
            <div
              key={index}
              onClick={() => setSlide(index)}
              className={`tcar-dot w-3 h-3 bg-${index === slide ? '[#ff6c53]' : 'gray-300'} rounded-full mx-1 cursor-pointer`}
            ></div>
          ))}
        </div>
      </div>
...
<section className="ctadb py-24 bg-[#ff6c53] text-white relative">
  <div className="max-w-6xl mx-auto px-6">
    <div className="ctadb-inner flex flex-col lg:flex-row items-center text-center lg:text-left">
      <div className="flex-1">
        <h2 className="text-4xl font-bold tracking-tight leading-tight anim d0">Deliver Exceptional Customer Support with Zoho Desk</h2>
        <p className="text-lg leading-relaxed mt-4 anim d1">Streamline customer service, manage tickets efficiently, and deliver seamless support experiences across every channel.</p>
        <div className="ctadb-btns flex flex-col sm:flex-row gap-4 mt-6 anim d2">
          <a href="#lead-form" className="ctadb-btn inline-flex items-center justify-center rounded-xl text-sm font-semibold h-11 px-6 bg-white text-[#ff6c53] shadow hover:-translate-y-0.5 hover:opacity-90 transition-all focus-visible:outline-none">Get Your Free Trial</a>
          <a href="#lead-form" className="ctadb-ghost inline-flex items-center justify-center rounded-xl text-sm font-semibold h-11 px-6 border border-white/20 text-white/80 hover:bg-white/10 transition-all">Get Started</a>
        </div>
      </div>
      <div className="flex-1 hidden lg:block relative overflow-hidden rounded-xl mt-8 lg:mt-0">
        <img src="/output/generated-assets/ds_1778228999760_93fb8902/12-bd4c399912.jpeg" alt="Zoho Desk" style={{width:'100%',height:'100%',objectFit:'cover',display:'block',position:'absolute',inset:0}}/>
      </div>
    </div>
  </div>
