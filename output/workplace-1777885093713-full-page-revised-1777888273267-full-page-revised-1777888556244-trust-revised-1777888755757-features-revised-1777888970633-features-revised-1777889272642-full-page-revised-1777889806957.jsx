...
const LandingPage = () => {
  ...
  const css = `
    ...
    *{box-sizing:border-box}
    ...
    .cta-band h3{font-size:34px;color:#fff;margin-bottom:8px}
    .cta-band p{margin:0;color:rgba(255,255,255,.8);line-height:1.7;max-width:700px}
    .cta-band .animated-cta{background:var(--primary)}
    .footer{padding:26px 0 34px;border-top:1px solid rgba(15,23,42,.06);background:#fff}
    ...
    .reveal,.reveal-left,.reveal-right,.reveal-scale,.stagger-parent>*{opacity:0;transform:translateY(22px);transition:all .7s cubic-bezier(.22,1,.36,1)}
    ...
    .visible.stagger-parent>*{opacity:1;transform:none}
    ...
    @media (max-width:1024px){
      .hero-grid,.overview-grid,.split-panel,.testimonial-wrap,.tabs-shell{grid-template-columns:1fr}
      .hero-grid{min-height:auto;padding:36px 0 28px}
    ...
    @media (max-width:767px){
      ...
      .overview-card,.testimonial-intro,.testimonial-card,.pricing-card,.preview-panel{padding:20px}
    ...
    <div className="page-wrapper lp">
      ...
      <nav className="nav">
        <div className="container nav-inner">
          <a href="#top" className="brand">Techjockey</a>
        ...
        <div className="container hero-grid">
          <div className="hero-copy">
            ...
            <h1 className="hero-headline">
              Power your business communication with <span className="gradient-text">Zoho Workplace</span>
            </h1>
            <p className="hero-sub">
              Zoho Workplace is an all-in-one business email and collaboration suite that helps teams communicate,
              create, meet, and work together from a single platform.
            </p>
            ...
            <div className="hero-proof reveal">
              ...
              <div className="proof-item">
                ...
                <span>Users reported security benefits</span>
              </div>
              <div className="proof-item">
                <strong data-count="42.9" data-suffix="%">0%</strong>
                <span>Easier remote access experience</span>
              </div>
            </div>
          </div>

          <div className="hero-visual" id="lead-form">
            <form ref={formRef} className="form-card reveal-scale" onSubmit={handleSubmit}>
              <h3>Talk to our product experts</h3>
              <p>Share your details and our team will help you choose the right Zoho Workplace plan for your business.</p>
        ...
        <div className="container">
          <div className="overview-grid">
            <div className="overview-card reveal-left">
              <h3>One suite for mail, collaboration and productivity</h3>
              <p>
                Zoho Workplace combines secure business email, team communication, online meetings, office apps and file management
                into one connected workspace so your teams can work faster without switching between disconnected tools.
              </p>
              <div className="mini-points stagger-parent visible">
                <div className="mini-point">
                  <strong>Ad-free business email</strong>
                  <span>Professional email hosting with admin controls and secure access.</span>
                </div>
                <div className="mini-point">
                  <strong>Built-in collaboration</strong>
                  <span>Chat, meetings, docs and files connected inside one platform.</span>
                </div>
                <div className="mini-point">
                  <strong>Remote-ready access</strong>
                  <span>Work across web and mobile from office, home or on the go.</span>
                </div>
                <div className="mini-point">
                  <strong>Unified experience</strong>
                  <span>Reduce tool sprawl and improve productivity across departments.</span>
                </div>
              </div>
            </div>
            <div className="overview-visual reveal-right">
              <img src="/output/generated-assets/ds_1777884843887_6f559a73/17-8ee9780f0b.jpg" alt="Zoho Workplace collaboration suite" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section bg-muted" id="features">
        <div className="container">
          <div className="section-head reveal">
            ...
            <p>
              Discover how Zoho Workplace helps your teams communicate effectively, collaborate in real time and stay productive with a unified business suite.
            </p>
          </div>
                  ...
                  <div className="feature-list">
                    {sections[activeTab].features.map((feature, index) => (
                      <div
                        ...
                        style={{
                          borderColor: activeFeature === index ? 'rgba(216,78,31,.34)' : undefined,
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="section-head reveal">
            <h2>What users value in Zoho Workplace</h2>
            <p>
              Users appreciate Zoho Workplace for its secure email experience, remote accessibility, ease of use and improved team collaboration.
            </p>
          </div>

          <div className="metrics stagger-parent reveal">
            <div className="metric-card">
              <h3 data-count="82.9" data-suffix="%">0%</h3>
              <p>Users reported a secure email experience with stronger protection and reliable communication.</p>
            </div>
            <div className="metric-card">
              <h3 data-count="42.9" data-suffix="%">0%</h3>
              <p>Users found it easier to work remotely with access across devices and locations.</p>
            </div>
            <div className="metric-card">
              <h3 data-count="28.6" data-suffix="%">0%</h3>
              <p>Users found the platform easy to use, helping teams adapt faster with less training.</p>
            </div>
            <div className="metric-card">
              <h3 data-count="14.3" data-suffix="%">0%</h3>
              <p>Users saw better collaboration, engagement and productivity across teams.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section bg-muted">
        <div className="container">
          <div className="section-head reveal">
            <h2>Customer experiences with Zoho Workplace</h2>
            <p>
              Businesses use Zoho Workplace to simplify communication, reduce tool dependency and improve collaboration across departments.
            </p>
          </div>
          ...
          <div className="testimonial-wrap">
            <div className="testimonial-intro reveal-left">
              ...
              <p>
                From business email to collaboration and file sharing, Zoho Workplace helps teams work better together while Techjockey assists in selecting the right plan.
              </p>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="cta-band reveal-scale">
            <div>
              <h3>Get expert help for Zoho Workplace</h3>
              <p>
                Compare plans, understand features and get the right Zoho Workplace recommendation for your business from Techjockey experts.
              </p>
            </div>
            <div>
              <a href="#lead-form" className="animated-cta btn-magnetic">Talk to Expert</a>
            </div>
          </div>
        </div>
      </section>
