...
const LandingPage = () => {
  ...
  const css = `
    ...
    *{box-sizing:border-box}
    ...
    .hero-human-panel{position:absolute;inset:0;border-radius:32px;overflow:hidden;background:#111827}
    .hero-human-panel video{width:100%;height:100%;object-fit:cover;object-position:center center}
    .hero-video-overlay{position:absolute;inset:0;background:linear-gradient(180deg,rgba(17,24,39,.10) 0%,rgba(17,24,39,.22) 100%);pointer-events:none}
    ...
    .hero-floating-card{position:absolute;right:20px;top:20px;z-index:3;padding:14px 16px;border-radius:18px;background:rgba(255,255,255,.90);backdrop-filter:blur(10px);border:1px solid rgba(255,255,255,.7);box-shadow:0 12px 30px rgba(15,23,42,.12);max-width:220px}
    .hero-floating-card strong{display:block;font-size:15px;color:#111827;margin-bottom:4px}
    .hero-floating-card span{display:block;font-size:12px;line-height:1.5;color:#4b5563}
    ...
    .testimonial-card{background:#fff;border:1px solid #e5e7eb;border-radius:28px;padding:32px;box-shadow:0 18px 50px rgba(15,23,42,.08);min-height:250px;display:grid;grid-template-columns:auto 1fr;gap:20px;align-items:center}
    .testimonial-card img{width:72px;height:72px;border-radius:50%;object-fit:cover}
    .testimonial-card blockquote{margin:0 0 14px;font-size:20px;line-height:1.7;color:#111827}
    .testimonial-card h4{margin:0;font-size:18px}
    .testimonial-card span{color:#6b7280;font-size:14px}
    .testimonial-dots{display:flex;justify-content:center;gap:8px;margin-top:18px}
    .testimonial-dots button{width:10px;height:10px;border-radius:50%;border:none;background:#d1d5db;cursor:pointer;padding:0}
    .testimonial-dots button.active{background:${accent}}
    .final-cta{background:linear-gradient(135deg,#111827 0%,#1f2937 100%);color:#fff;border-radius:32px;padding:44px;display:grid;grid-template-columns:1fr auto;align-items:center;gap:24px}
    .final-cta h2{font-size:40px;line-height:1.1;margin:0 0 12px}
    .final-cta p{margin:0;color:rgba(255,255,255,.78);font-size:17px;line-height:1.7}
    .footer{background:#111827;color:#fff;padding:28px 0}
    .footer-inner{display:flex;justify-content:space-between;gap:20px;align-items:center;flex-wrap:wrap}
    .footer-links{display:flex;gap:16px;flex-wrap:wrap;color:rgba(255,255,255,.7);font-size:14px}
    .socials{display:flex;align-items:center;gap:12px}
    .socials a{width:36px;height:36px;border-radius:50%;display:grid;place-items:center;background:rgba(255,255,255,.08);transition:.2s}
    .socials a:hover{background:rgba(255,255,255,.16)}
    .reveal{opacity:0;transform:translateY(24px);transition:opacity .7s ease, transform .7s ease}
    .reveal.visible{opacity:1;transform:none}
    .clip-reveal{clip-path:inset(14% 10% 14% 10%)}
    ...
    .cursor-glow{position:fixed;top:0;left:0;width:220px;height:220px;border-radius:50%;pointer-events:none;background:radial-gradient(circle,rgba(228,41,43,.10) 0%,rgba(228,41,43,0) 72%);filter:blur(16px);transform:translate(-50%,-50%);z-index:1}
    @media (max-width: 991px){
      .hero-grid,.feature-section-grid,.final-cta,.testimonial-card{grid-template-columns:1fr}
      .hero{padding-top:54px}
      .hero h1{font-size:54px}
      .hero-visual-wrap,.hero-visual{min-height:460px}
    ...
    @media (max-width: 767px){
      ...
      .hero-floating-card{right:16px;top:16px;max-width:190px}
      ...
      <div className="lp">
        <nav className="nav" ref={stickyRef}>
          <div className="container nav-inner">
            <a className="brand" href="https://www.techjockey.com/" target="_blank" rel="noreferrer">
        ...
        <section className="hero">
          <div className="container hero-grid">
            <div className="hero-copy reveal">
              ...
              <h1>Unify Email, Chat, Meetings & Docs with Zoho Workplace</h1>
              <p>
                Zoho Workplace brings your business email, team communication, file storage, office suite, and online meetings
                into one connected platform so your teams can work faster and collaborate better.
              </p>

              <div className="chips">
                <div className="chip">Business Email</div>
                <div className="chip">Team Collaboration</div>
                <div className="chip">Online Meetings</div>
                <div className="chip">Secure File Storage</div>
              </div>
              ...
              <div className="hero-actions">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  style={{ color: '#111827', borderColor: 'rgba(17,24,39,.14)', background: '#fff' }}
                >
                  Explore Platform
                </a>
              </div>
              ...
              <div className="supporting">
                Trusted by businesses looking for a unified, secure, and scalable collaboration suite.
              </div>
            </div>
            ...
            <div className="hero-visual-wrap reveal">
              <div className="hero-visual zoom-reveal">
                ...
                <div className="hero-floating-card">
                  <strong>Smarter teamwork</strong>
                  <span>One platform for communication, collaboration, and productivity.</span>
                </div>

                <div className="hero-image-caption">
                  <div className="caption-dot" />
                  <span>Built for modern teams that need secure communication and seamless collaboration.</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="container">
              ...
              {section.label !== 'INSIGHT' ? (
                <div className="feature-section-grid">
                  <div className={`media-card reveal clip-reveal scene-expand ${section.browser ? 'browser-card' : ''}`}>
                    {section.browser ? (
                      <>
                ...
                <div className="feature-section-grid">
                  <div className="media-card reveal clip-reveal browser-card">
                    <div className="browser-top">
                      <span style={{ width: 10, height: 10, borderRadius: '50%', background: '#f87171' }} />
                      <span style={{ width: 10, height: 10, borderRadius: '50%', background: '#fbbf24' }} />
                      <span style={{ width: 10, height: 10, borderRadius: '50%', background: '#34d399' }} />
                  ...
                  <div className="insight-grid">
                    {section.features.map((feature) => (
                      <div className="stat-card reveal" key={feature.title}>
        ...
        <section className="section section-alt">
          <div className="container">
            <div className="section-head reveal">
              ...
              <p>Real experiences from professionals using Zoho Workplace to improve communication and teamwork.</p>
            </div>
            ...
            <div className="testimonial-slider reveal">
              <div className="testimonial-card">
                ...
                <div>
                  <blockquote>"{testimonials[activeSlide].quote}"</blockquote>
          ...
          <div className="container">
            <div className="final-cta reveal">
              <div>
                ...
                <p>
                  Connect with Techjockey experts to understand pricing, features, and the best-fit Zoho Workplace package
            ...
            <div className="socials">
              <a href="https://www.facebook.com/techjockey/" target="_blank" rel="noreferrer" aria-label="Facebook">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M13.5 8H16V4.5h-2.5C10.46 4.5 9 6.26 9 9.32V11H6v3.5h3V21h3.5v-6.5H16L16.5 11h-4V9.68c0-.98.26-1.68 1-1.68z" />
                </svg>
              </a>
              <a href="https://www.linkedin.com/company/techjockey-infotech-pvt-ltd/" target="_blank" rel="noreferrer" aria-label="LinkedIn">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M6.94 8.5A1.94 1.94 0 1 1 6.94 4.62 1.94 1.94 0 0 1 6.94 8.5zM5.25 9.75h3.38V20.5H5.25V9.75zm5.5 0h3.25v1.47h.05c.45-.85 1.56-1.75 3.22-1.75 3.44 0 4.08 2.27 4.08 5.22v5.8H18V15.4c0-1.22-.02-2.79-1.7-2.79-1.7 0-1.96 1.33-1.96 2.7v5.19h-3.59V9.75z" />
                </svg>
              </a>
